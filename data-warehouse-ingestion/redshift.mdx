---
title: Redshift
description: "Configure Statsig data warehouse ingestion from Amazon Redshift, including authentication, scheduled queries, and mapping to events and properties."
keywords:
  - owner:tim
last_update:
  date: 2025-09-18
...
<Frame>
  <img src="/images/statsig-warehouse-native/connecting-your-warehouse/redshift/187515405-17fa7d90-44e1-422f-87a7-cfde090637ed.png" alt="AWS Redshift cluster details highlighting endpoint and admin user" />
</Frame>
...
<Frame>
  <img src="/images/data-warehouse-ingestion/redshift/188943178-6b541962-62da-4529-b5af-ff59b20b7a8d.png" alt="Statsig Redshift connection setup form showing cluster endpoint and credentials fields" />
</Frame>
