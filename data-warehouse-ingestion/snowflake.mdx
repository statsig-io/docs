---
title: Snowflake
description: "Configure Statsig data warehouse ingestion from Snowflake, including authentication, scheduled queries, and mapping to events and user properties."
keywords:
  - owner:tim
last_update:
  date: 2025-09-18
...
<Frame>
  <img src="/images/statsig-warehouse-native/connecting-your-warehouse/snowflake/187517221-4bb3dce3-8b8f-4f30-b4d4-fd12e5249722.png" alt="Snowflake console footer showing account identifier link" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/connecting-your-warehouse/snowflake/195217037-ad630f37-a8fe-4b61-823f-ce0e8c984ed0.png" alt="Snowflake account profile interface" />
</Frame>
</Info>
...
<Frame>
  <img src="/images/statsig-warehouse-native/connecting-your-warehouse/snowflake/187517225-017b4626-eaea-443b-a042-59fd474ae657.png" alt="Snowflake database explorer highlighting schema selection" />
</Frame>
...
<Frame>
  <img src="/images/data-warehouse-ingestion/snowflake/8bb56be6-1aca-4d8a-98de-6b82d251d59b.png" alt="Private key authentication configuration interface" />
</Frame>
...
<Frame>
  <img src="/images/data-warehouse-ingestion/redshift/188943178-6b541962-62da-4529-b5af-ff59b20b7a8d.png" alt="Advanced connection settings for warehouse ingestion showing credential inputs" />
</Frame>
