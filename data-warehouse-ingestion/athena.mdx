...
description: "Configure Statsig data warehouse ingestion from Amazon Athena, including authentication, scheduled queries, and mapping to events and properties."
sidebarTitle: Athena
keywords:
  - owner:tim
last_update:
