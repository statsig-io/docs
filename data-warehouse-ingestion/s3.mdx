...
last_update:
  date: 2025-09-18
description: To set up connection with S3, Statsig needs the following - Region - Bucket Name - Granting Bucket Read Access Permissions to a Statsig-owned Service 
---
