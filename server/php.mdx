...
sidebarTitle: PHP
description: Reference for the legacy Statsig PHP server SDK to evaluate feature gates, experiments, and dynamic configs and log events from PHP backend applications.
icon: "php"
---
