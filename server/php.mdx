...
sidebarTitle: PHP
description: Statsig's legacy PHP Server SDK for evaluating feature gates, experiments, and dynamic configs in PHP backend applications. New projects use PHP Core.
icon: "php"
---
