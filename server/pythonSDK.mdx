...
sidebarTitle: Python
description: Reference for the legacy Statsig Python server SDK. Evaluate feature gates, experiments, and dynamic configs in Python services; use Python Core for new code.
icon: "python"
---
