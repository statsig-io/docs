...
sidebarTitle: Python
description: Statsig's legacy Python Server SDK for evaluating feature gates, experiments, and dynamic configs in Python backend services. New projects use Python Core.
icon: "python"
---
