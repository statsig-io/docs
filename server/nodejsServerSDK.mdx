...
description: Statsig's legacy Node.js Server SDK for evaluating feature gates, experiments, and dynamic configs in Node backend services. New projects use Node Core.
icon: "node-js"
---
