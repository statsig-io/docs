...
description: Reference for the legacy Statsig Node.js server SDK; use Node Core for new projects. Evaluate feature gates, experiments, and dynamic configs in Node services.
icon: "node-js"
---
