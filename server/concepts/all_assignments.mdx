...
description: "How Statsig server SDKs report all feature gate, experiment, and dynamic config assignments for a user in a single call for server-rendered apps."
