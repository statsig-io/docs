...
last_update:
  date: 2025-09-18
description: This guide walks you through setting up the Cloudflare Logpush worker in your Cloudflare account and configuring it to send logs and metrics to Statsi
---
