...
description: "Configure persistent assignment in Statsig server SDKs so users stay in the same experiment group across requests, sessions, and devices over time."
---
