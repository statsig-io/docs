...
description: Reference for the legacy Statsig Erlang and Elixir server SDK to evaluate feature gates, experiments, and dynamic configs and log events from BEAM services.
icon: "erlang"
---
