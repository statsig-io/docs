...
description: Statsig's legacy Erlang and Elixir Server SDK for evaluating feature gates, experiments, and dynamic configs in BEAM-based backend services and apps.
icon: "erlang"
---
