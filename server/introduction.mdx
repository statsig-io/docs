---
title: Server SDKs
description: Statsig server SDKs evaluate feature gates, dynamic configs, and experiments locally on your application server for backend APIs and infrastructure rollouts.
---
