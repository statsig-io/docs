...
description: Reference for the legacy Statsig Go server SDK. Evaluate feature gates, experiments, and dynamic configs in Go services. Use Go Core for new projects.
icon: "golang"
---
