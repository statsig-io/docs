...
description: Statsig's legacy Go Server SDK for evaluating feature gates, experiments, and dynamic configs. New Go projects should use the Go Core SDK instead.
icon: "golang"
---
