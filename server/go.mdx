---
title: Legacy Go Server SDK
sidebarTitle: Go (Legacy)
description: Statsig's legacy Server SDK for Go applications; use Go Core for new projects
icon: "golang"
---
...
//
// NOTE: UserID or a customID is **required** - see /sdks/user#why-is-an-id-always-required-for-server-sdks
