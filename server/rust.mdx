...
sidebarTitle: Rust
description: Reference for the legacy Statsig Rust server SDK to evaluate feature gates, experiments, and dynamic configs and log events from Rust backend services.
icon: "rust"
---
