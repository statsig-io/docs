...
sidebarTitle: Rust
description: Statsig's legacy Rust Server SDK for evaluating feature gates, experiments, and dynamic configs in Rust backend services. New projects use Rust Core SDK.
icon: "rust"
---
