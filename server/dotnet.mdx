...
sidebarTitle: .NET
description: Statsig's legacy .NET Server SDK for evaluating feature gates, experiments, and dynamic configs in C# backend services. New projects should use .NET Core SDK.
