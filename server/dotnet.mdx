...
sidebarTitle: .NET
description: Reference for the legacy Statsig .NET server SDK to evaluate feature gates, experiments, and dynamic configs and log events from .NET backend services.
