...
sidebarTitle: Ruby
description: Use the Statsig Ruby Server SDK to evaluate feature gates, experiments, and dynamic configs from Ruby and Ruby on Rails backend applications.
icon: "gem"
---
