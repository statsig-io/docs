...
sidebarTitle: Ruby
description: Use the Statsig server SDK in Ruby and Rails services to evaluate feature gates, run experiments, retrieve dynamic configs, and log events locally.
icon: "gem"
---
