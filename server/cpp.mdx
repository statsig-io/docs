...
title: C++ Server SDK
sidebarTitle: C++
description: Use the Statsig server SDK in C++ services to evaluate feature gates, run experiments, retrieve dynamic configs, and log events with local rule evaluation.
icon: "c"
---
