...
title: C++ Server SDK
sidebarTitle: C++
description: Use the Statsig C++ Server SDK to evaluate feature gates, run experiments, and log events from native C++ backend services with low-latency evaluation.
icon: "c"
---
