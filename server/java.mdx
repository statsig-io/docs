...
description: Statsig's legacy Java and Kotlin Server SDK for evaluating feature gates, experiments, and dynamic configs in JVM backend services. New projects use Java Core.
icon: "java"
---
