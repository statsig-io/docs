...
description: Reference for the legacy Statsig Java and Kotlin server SDK to evaluate feature gates, experiments, and dynamic configs and log events from JVM backends.
icon: "java"
---
