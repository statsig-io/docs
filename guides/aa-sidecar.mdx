...
description: Run an A/A test with the Statsig Sidecar Chrome extension to validate your experimentation setup and confirm metrics fire correctly before launching A/B tests.
---
