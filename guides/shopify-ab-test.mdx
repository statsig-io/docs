...
description: "Run A/B tests on a Shopify storefront with Statsig, including adding the SDK to your theme, defining variants, and tracking order conversion metrics."
keywords:
  - owner:brock
last_update:
  date: 2025-09-18
...
- Paste the Visual Editor script tag toward the top of the page `<head>` as shown below.
