...
description: Step-by-step tutorial to create your first Statsig dynamic config, including building a flexible homepage banner that you can update without redeploying.
---
...
<Frame>
  <img src="/images/guides/first-dynamic-config/b82e808a-99b5-4922-90f7-727d9e5d942a.png" alt="UI for mac users" />
</Frame>
...
<Frame>
  <img src="/images/guides/first-dynamic-config/c0564d86-a83c-45c7-a3c3-62397ae00448.png" alt="Create Dynamic Config" />
</Frame>
...
<Frame>
  <img src="/images/guides/first-dynamic-config/9011708a-24e0-43c9-8e4d-468d57476413.png" alt="Add Rule" />
</Frame>
...
<Frame>
  <img src="/images/guides/first-dynamic-config/a2dc7b2a-98f4-4570-86db-34b390d80a89.png" alt="Return Value" />
</Frame>

Remember to hit "Save" in the bottom right.

<Frame>
  <img src="/images/guides/first-dynamic-config/b6e0eb73-c623-4a05-b605-ad9eb2c42792.png" alt="Config with one rule" />
</Frame>
...
<Frame>
  <img src="/images/guides/first-dynamic-config/a04575a8-6afb-4380-8cb6-77052a2d5943.png" alt="Dynamic Config with two rules" />
</Frame>
...
<Frame>
  <img src="/images/guides/first-dynamic-config/8211d6ea-db5f-448b-9589-e112de3ac4b2.png" alt="dynamic config code snippet button" />
</Frame>
