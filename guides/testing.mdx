...
- Non-production events appear in diagnostics and can be used to track cumulative exposures and metric results when testing experiments in lower environments. Production data is prioritized for final Pulse analyses.
