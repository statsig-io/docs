...
description: "Run Statsig experiments using custom ID types like company ID, account ID, or device ID instead of the default user ID for B2B and device-level tests."
