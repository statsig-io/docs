...
- `update_experiment_settings`: Changing settings of an ongoing experiment
  - will contain payloads `old_experiment` and `new_experiment` with the same format returned by the console API ([/api-reference/experiments/get-experiment](/api-reference/experiments/get-experiment))
