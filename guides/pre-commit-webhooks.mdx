...
description: "Configure pre-commit and pre-publish webhooks in Statsig to enforce review checks, run validations, or trigger CI workflows before changes are saved."
---
