...
description: Step-by-step guide to creating and implementing your first A/B test experiment in Statsig
doc_type: tutorial
keywords:
  - a/b test
  - experiment
...
prerequisites:
  - Statsig account
  - Statsig SDK installed in your application
---
...
* Monitored experiment diagnostics in real-time
* Understood how to read experiment results
...
<Frame>
  <img src="/images/guides/abn-tests/b0ab8c0e-4f13-4b2b-bf58-1f8a09d8d4a7.png" alt="Experiment Diagnostics" />
</Frame>
...
<Frame>
  <img src="/images/guides/abn-tests/7e203d73-dbf9-4f27-87fb-b05269dd4173.png" alt="Example experiment results" />
</Frame>
