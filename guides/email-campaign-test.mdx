...
Note that these generic patterns can be used across almost any email marketing tool (Braze, Customer.io, Sendgrid and Salesforce Marketing Cloud). In some cases, we have more specific integrations that simplify this workflow like with [Customer.io](https://docs.statsig.com/guides/customer-io-email-abtest/). 
