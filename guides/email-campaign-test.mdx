...
These standard patterns can be used across almost any email marketing tool (Braze, [Customer.io](/customer-io-email-abtest/), [Sendgrid](/sendgrid-email-abtest), and Salesforce Marketing Cloud).
