...
These standard patterns can be used across almost any email marketing tool (Braze, [Customer.io](https://docs.statsig.com/guides/customer-io-email-abtest/), [Sendgrid](https://docs.statsig.com/guides/sendgrid-email-abtest), and Salesforce Marketing Cloud).
