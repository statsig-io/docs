...
description: "View and audit configuration history in Statsig for feature gates, experiments, dynamic configs, and metrics, including who changed what and when."
keywords:
  - owner:shubham
last_update:
  date: 2025-09-18
