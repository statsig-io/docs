...
last_update:
  date: 2025-09-18
description: In this guide, we will walk you through how to leverage Statsig’s platform in serverless environments.  The examples in this guide use the `statsig-no
---
