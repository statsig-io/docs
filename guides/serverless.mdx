...
description: "Use Statsig in serverless environments like AWS Lambda, Vercel Functions, and Cloudflare Workers, including initialization patterns and cold start tips."
keywords:
  - owner:brock
last_update:
  date: 2025-09-18
