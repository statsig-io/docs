...
description: "Integrate Statsig with CMS platforms like Contentful, Webflow, and Framer to run content experiments and personalize pages without redeploying code."
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
...
<Frame>
  <img src="/images/guides/cms-integrations/187345904-90ade71e-adc7-4205-85c7-751633a864da.png" alt="Statsig landing page diagram showing CMS-provided sections" />
</Frame>

First, lets create a layer. Navigate to "Experiments" in the left hand column, and then "Layers" in the title bar:

<Frame>
  <img src="/images/guides/cms-integrations/187341751-7c5861a7-90cd-494d-b84d-75c9ea54f923.png" alt="Layers list and create button in Statsig experiments UI" />
</Frame>
...
<Frame>
  <img src="/images/guides/cms-integrations/187346608-3314ca52-4c99-4442-b056-7081369d2b8f.png" alt="Create layer dialog naming statsig_landing_page" />
</Frame>
...
<Frame>
  <img src="/images/guides/cms-integrations/187346653-1be62abe-e6b9-4ed6-9bf6-b95e7b04e040.png" alt="Layer parameter creation form for CMS content IDs" />
</Frame>

It should look like this when you are done:

<Frame>
  <img src="/images/guides/cms-integrations/187346571-85013f61-6ca6-42f5-9c41-b4631931f93e.png" alt="Layer parameters table listing title, subtitle, and CTA defaults" />
</Frame>
...
<Frame>
  <img src="/images/guides/cms-integrations/187347191-ac9a27bb-3ea3-4338-8680-c94b6d1e753b.png" alt="Create experiment in layer button location" />
</Frame>

Fill out the resulting form:

<Frame>
  <img src="/images/guides/cms-integrations/187347290-fc3ebc84-1cf0-4f3a-8256-d6cc5a4b21b3.png" alt="Layer experiment setup form with control and test weights" />
</Frame>
...
<Frame>
  <img src="/images/guides/cms-integrations/187347358-f336195a-0fa5-42d0-9896-ea0e0cf85875.png" alt="Groups and parameters section showing Add Parameter menu" />
</Frame>

<Frame>
  <img src="/images/guides/cms-integrations/187347464-e4a2dbe6-bcb8-48f1-b807-339f59b6e0b2.png" alt="Parameter value editor selecting CMS ID per group" />
</Frame>

Update the value of the parameter to the id of the new title:
<Frame>
  <img src="/images/guides/cms-integrations/187347517-77ff4cfb-8f52-4db3-9dd1-92e453076b01.png" alt="Updated parameter table showing new CMS content IDs per variation" />
</Frame>
