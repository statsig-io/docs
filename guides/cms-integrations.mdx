...
last_update:
  date: 2025-09-18
description: One fairly common question we get is around how to use Statsig with an existing CMS. While we also offer a no-code solution - [Sidecar](/guides/sideca
---
...
<Frame>
  <img src="/images/guides/cms-integrations/187345904-90ade71e-adc7-4205-85c7-751633a864da.png" alt="Screen Shot 2022-08-29 at 8 26 09 PM" />
</Frame>

First, lets create a layer. Navigate to "Experiments" in the left hand column, and then "Layers" in the title bar:

<Frame>
  <img src="/images/guides/cms-integrations/187341751-7c5861a7-90cd-494d-b84d-75c9ea54f923.png" alt="Screen Shot 2022-08-29 at 8 21 39 PM" />
</Frame>
...
<Frame>
  <img src="/images/guides/cms-integrations/187346608-3314ca52-4c99-4442-b056-7081369d2b8f.png" alt="Screen Shot 2022-08-29 at 9 01 56 PM" />
</Frame>
...
<Frame>
  <img src="/images/guides/cms-integrations/187346653-1be62abe-e6b9-4ed6-9bf6-b95e7b04e040.png" alt="Screen Shot 2022-08-29 at 9 02 35 PM" />
</Frame>

It should look like this when you are done:

<Frame>
  <img src="/images/guides/cms-integrations/187346571-85013f61-6ca6-42f5-9c41-b4631931f93e.png" alt="Screen Shot 2022-08-29 at 9 03 04 PM" />
</Frame>
...
<Frame>
  <img src="/images/guides/cms-integrations/187347191-ac9a27bb-3ea3-4338-8680-c94b6d1e753b.png" alt="Screen Shot 2022-08-29 at 9 08 49 PM" />
</Frame>

Fill out the resulting form:

<Frame>
  <img src="/images/guides/cms-integrations/187347290-fc3ebc84-1cf0-4f3a-8256-d6cc5a4b21b3.png" alt="Screen Shot 2022-08-29 at 9 09 39 PM" />
</Frame>
...
<Frame>
  <img src="/images/guides/cms-integrations/187347358-f336195a-0fa5-42d0-9896-ea0e0cf85875.png" alt="Screen Shot 2022-08-29 at 9 10 14 PM" />
</Frame>

<Frame>
  <img src="/images/guides/cms-integrations/187347464-e4a2dbe6-bcb8-48f1-b807-339f59b6e0b2.png" alt="Screen Shot 2022-08-29 at 9 11 12 PM" />
</Frame>

Update the value of the parameter to the id of the new title:
<Frame>
  <img src="/images/guides/cms-integrations/187347517-77ff4cfb-8f52-4db3-9dd1-92e453076b01.png" alt="Screen Shot 2022-08-29 at 9 11 43 PM" />
</Frame>
