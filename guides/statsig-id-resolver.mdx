...
description: "Use the Statsig ID resolver to deduplicate and stitch user identities across anonymous and logged-in sessions for consistent experiment exposures."
keywords:
  - owner:shubham
last_update:
  date: 2025-09-18
