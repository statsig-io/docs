...
<Frame>
  <img src="/images/guides/sidecar-experiments/setup/0fc7cf69-3668-4f1b-bdaf-c75a25ca96af.png" alt="Statsig Sidecar Extension in the Chrome Web Store" />
</Frame>
...
<Frame>
  <img src="/images/guides/sidecar-experiments/setup/e069d1f2-c437-4398-a381-681b76663178.png" alt="Chrome extensions menu with Statsig Sidecar option" />
</Frame>
...
<Frame>
  <img src="/images/guides/sidecar-experiments/setup/754cc245-1821-4f75-a87d-08b536422587.png" alt="Statsig console Keys & Environments panel showing API keys" />
</Frame>
...
Add a single script tag within the `<head>` portion of your website, replacing with your own [Client SDK Key](https://docs.statsig.com/sdk-keys/api keys/) as shown in the following example.

```text
<script src="https://cdn.jsdelivr.net/npm/statsig-sidecar/dist/index.min.js?api key=REPLACE_WITH_YOUR_CLIENT_SDK_KEY"></script>
```
