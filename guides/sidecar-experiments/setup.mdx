...
description: Install and configure the Statsig Sidecar Chrome extension, connect it to your website, and verify the integration before launching no-code experiments.
---
