...
description: Set up the Google Tag Manager integration with Statsig Sidecar to automatically send GTM-tagged events to Statsig for experiment metric tracking.
---
