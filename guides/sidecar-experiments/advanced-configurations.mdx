...
description: Configure advanced Sidecar features including Single Page App support, targeting, segmentation, consent management, and cross-domain tracking.
---
...
<Frame>
  <img src="/images/sidecar-spa.png" alt="Single Page App configuration settings in Sidecar" />
</Frame>
