...
description: Create and configure A/B experiments using the Statsig Sidecar Chrome extension without writing code or deploying changes to your production application.
---
...
<Frame>
  <img src="/images/guides/sidecar-experiments/creating-experiments/d8cfc8bb-43e9-4a64-8ca8-002c579e7fff.png" alt="New experiment creation form" />
</Frame>
