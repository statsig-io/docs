...
description: "Configure advanced Statsig Sidecar v3 settings, including custom triggers, multi-page tests, and integrations with analytics tools and consent providers."
keywords:
  - owner:brock
last_update:
  date: 2026-04-01
...
<!-- Visual Editor v3 script below -->
<script src="https://cdn.jsdelivr.net/npm/statsig-sidecar-v2-beta/dist/index.min.js?apikey=[client-YOUR-STATSIG-CLIENT-KEY]"></script>
```
