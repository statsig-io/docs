...
description: You can enable reviews for all Statsig resources such as feature flags, dynamic configs, segments, and experiments that you'll likely deploy to a prod
---
You can enable reviews for all Statsig resources such as feature flags, dynamic configs, segments, and experiments that you'll likely deploy to a production environment. 
...
<Frame>
  <img src="/images/guides/setting-up-reviews/45a439b5-7cf7-4f32-82d0-596c089f2359.png" alt="Project settings reviews configuration interface" />
</Frame>
...
<Frame>
  <img src="/images/guides/setting-up-reviews/4b7db056-a6be-4a76-99c9-08f8dc053ed8.png" alt="User role permissions configuration screen" />
</Frame>
...
<img width="1168" alt="Screen Shot 2022-05-04 at 5 08 21 AM" src="/images/guides/setting-up-reviews/166678241-272adade-ca60-4942-bd04-a1413d54864c.png"/>
...
<Frame>
  <img src="/images/guides/setting-up-reviews/1b1c72a9-ac98-4590-8690-c39d2e68489a.png" alt="Teams creation interface" />
</Frame>

You can now use these predefined **Teams** when you submit any changes for review.

<Frame>
  <img src="/images/guides/setting-up-reviews/166684577-29598c7f-fcba-4c7e-848d-9a45b031bd79.png" alt="Team selection for review submission" />
</Frame>
...
<img width="655" alt="image" src="/images/guides/setting-up-reviews/166682283-c9e2de57-0b9a-473e-adf2-100a240ab6b0.png"/>

<img width="458" alt="Screen Shot 2022-05-04 at 5 14 57 AM" src="/images/guides/setting-up-reviews/166682177-d44411e6-c4ab-49fe-9250-c77b063621af.png"/>
...
<Frame>
  <img src="/images/guides/setting-up-reviews/231233087-5b87310d-b33b-456e-b1a7-7a73555c8100.png" alt="Screen Shot 2023-04-11 at 9 47 12 AM" />
</Frame>

<Frame>
  <img src="/images/guides/setting-up-reviews/231233356-967c9785-5a89-4cac-a04a-e3f11cb7bb12.png" alt="Screen Shot 2023-04-11 at 9 48 02 AM" />
</Frame>
...
<Frame><img width="495" height="335" alt="Screen Shot 2025-09-11 at 1 46 56 PM" src="/images/guides/setting-up-reviews/49c408da-0910-4a90-9ee3-7d1e114c9013.png" /></Frame>

<Frame><img width="497" height="259" alt="Screen Shot 2025-09-11 at 1 47 08 PM" src="/images/guides/setting-up-reviews/a01617b2-3bb0-4f20-a505-b9318dd220a7.png" /></Frame>
