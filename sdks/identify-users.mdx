...
description: "How to identify users in Statsig SDKs using user IDs, custom IDs, and user properties so feature gates and experiments evaluate consistently."
---
