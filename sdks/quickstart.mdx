...
description: Get data flowing into Statsig with only a few lines of code using a Statsig SDK to log events, evaluate feature gates, and run your first experiment. 
---
