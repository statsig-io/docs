...
sidebarTitle: Roku
description: Install the Statsig Roku SDK to evaluate feature gates, run experiments, and log analytics events from BrightScript and SceneGraph Roku applications.
