...
description: Use the Statsig JavaScript on-device evaluation SDK in browser and Node.js apps to evaluate feature gates and experiments locally with low latency.
icon: "js"
---
...
import JSFlush from '/snippets/local-eval/js/_flush.mdx'
