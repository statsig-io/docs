...
description: Integrate the Statsig Angular SDK to run experiments, evaluate feature flags, and capture analytics events from Angular single page applications.
icon: "angular"
---
