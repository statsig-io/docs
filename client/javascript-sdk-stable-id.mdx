...
description: "How the Statsig JavaScript client SDK manages the stable ID for anonymous users, including storage, persistence, and overriding the default behavior."
---
