...
description: StableID is a concept in Statsig that allows us to have a consistent identifier for a single device. This allows Statsig to run [experiments on logged
---
