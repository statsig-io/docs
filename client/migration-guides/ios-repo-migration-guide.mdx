...
last_update:
  date: 2025-09-18
description: We renamed the iOS/macOS/tvOS repo from `ios-sdk` to `statsig-kit` The Statsig Swift SDK repo used to live on `statsig-io/ios-sdk`. Since Xcode uses t
---
...
![Ios Repo Migration Xcode](/images/ios-repo-migration-xcode.png)
