...
description: Migrate from the legacy statsig-react package to the new @statsig/react-bindings library, with import, provider, and hook changes for the modern SDK.
---
