...
description: Step-by-step guide to migrate from the legacy statsig-js SDK to the new @statsig/js-client SDK, including API changes, imports, and configuration updates.
---
