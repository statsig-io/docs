...
* Manual exposure logging methods have been deprecated (`getExperimentWithExposureLoggingDisabled`, `checkGateWithExposureLoggingDisabled`). The checkGate and getExperiment methods now support a second argument to suppress exposure logging [as shown here](/client/javascript-sdk/#manual-exposures-).
