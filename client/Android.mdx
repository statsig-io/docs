...
description: Install and use the Statsig Android SDK in Java and Kotlin apps to run experiments, evaluate feature flags, and log analytics events on Android devices.
icon: "Android"
---
