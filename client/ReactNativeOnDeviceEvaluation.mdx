...
description: Use the Statsig React Native on-device evaluation SDK to evaluate feature gates and experiments locally with low latency for mobile React Native apps.
icon: "react"
---
