...
description: Parameter Stores provide a new way to organize and manage parameters in your web or mobile app via the Statsig console. Now available for JS, React, R
---
...
Rather than thinking in terms of Statsig entities like Feature Flags, Experiments, Layers, or Dynamic Configs, Parameter Stores let you focus on **parameters**—the values in your app that need to be configurable remotely. 
...
When the time comes to run an experiment, we can point these variables directly at experiments - starting an Experiment without writing a line of code:
