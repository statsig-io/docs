...
description: A common limitation of experimentation systems is the **dependence on an upfront network requests to fetch experiment configurations**. While concepts
---
