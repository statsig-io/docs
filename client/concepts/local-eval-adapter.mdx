...
description: "Use the local evaluation data adapter in Statsig client SDKs to bootstrap evaluations from a custom data source, file, or server-rendered payload."
---
