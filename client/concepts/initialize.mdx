...
description: "Initialize Statsig client SDKs correctly across web, mobile, and React Native applications to ensure feature gates and experiments evaluate as expected."
---
