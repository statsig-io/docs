...
description: "Configure persistent assignment in Statsig client SDKs so users stay in the same experiment group across sessions and devices for consistent experiences."
---
