...
description: Use and customize the StatsigEvaluationsDataAdapter to cache, fetch, and bootstrap evaluation data for the Statsig JavaScript client SDK.
---
...
Bootstrapping allows you to provide data for a given `StatsigUser`. This can be useful if you are running a
