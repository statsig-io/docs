...
description: Create and manage ID List segments in Statsig to target specific users by their identifiers, such as user IDs, emails, or custom IDs uploaded as a list.
---
...
3. Toggle the segment type from **Conditional** to **ID List**.
   <Frame>
     <img
       src="/images/segments/add-id-list/af7c5cb3-adc2-4e88-a411-b5844a541e49.png"
...
4. Select the **ID type** you want to build from.
   <Frame>
     <img
       src="/images/segments/add-id-list/958b7545-7f23-4559-8a66-99af01d39952.png"
       alt="Create New Segment"
     />
   </Frame>
...
- **Manual Entry**: Enter IDs directly into the input box.
  <Frame>
    <img
      src="/images/segments/add-id-list/ee94e6bc-475b-47a0-96a7-5ddba398d58c.png"
      alt="Create New Segment"
    />
  </Frame>
...
e.g. pass in user_type:Paid or user_type:Trial in the User object, instead of having ID Lists that enumerate the Paid and Trial users. 
