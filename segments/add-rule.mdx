---
title: Adding Rules
description: Create rules in Statsig segments that define which users are included based on user attributes, custom properties, country, app version, and more.
---
