---
title: Adding Rules
description: Step-by-step guide to adding rules to a Statsig segment using user attributes, custom fields, and condition operators to define which users are included.
---
...
<Frame>
  <img src="/images/segments/add-rule/129094975-a78b8caf-ac0d-4b14-96f7-adba2fe73f1f.png" alt="Segment rule configuration interface" />
</Frame>
