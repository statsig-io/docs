---
title: Segments
description: Create and use Statsig segments to define reusable sets of users for targeting across feature gates, experiments, and dynamic configs in one place.
---
## What is a segment?
