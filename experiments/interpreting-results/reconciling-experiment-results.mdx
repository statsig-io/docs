...
description: "Reconcile differences in experiment results between Statsig and other analysis platforms, including common sources of discrepancy and how to debug them."
---
## Motivation
