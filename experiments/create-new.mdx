...
description: "Step-by-step guide to creating a new experiment in the Statsig console, including hypothesis, allocation, targeting rules, and scorecard metric setup."
---
