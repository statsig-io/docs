...
To configure **Targeting** criteria, click to edit the **Targeting** section. You can either set new targeting criteria or use an existing **Feature Flag**. This will limit the experiment to only the users who meet the defined conditions.
