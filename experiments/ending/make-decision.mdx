...
<img width="746" alt="Layer configuration showing default parameter value before experiment" src="/images/experiments/ending/make-decision/162633143-3ddd9652-4e99-4760-aac0-c89dec8ce70c.png" />

Say you decide to create an experiment, **Demo Experiment** in **Demo Layer** as shown below. 

<img width="383" alt="Experiment creation dialog in Demo Layer with control and test groups" src="/images/experiments/ending/make-decision/162633041-633de059-f676-4f76-a0ef-4d17b03648a0.png" />
...
<img width="630" alt="Experiment parameter table comparing control and test values for a_param" src="/images/experiments/ending/make-decision/162633712-a5e889dd-32ba-4248-8524-b6d5555b4dfd.png" />
...
<img width="455" alt="Layer defaults updated to use control group value experiment_one_control" src="/images/experiments/ending/make-decision/162630956-1ffaa81f-c95f-4df7-9ced-b138cfe26d96.png" />
...
<img width="454" alt="Layer defaults updated to use test group value experiment_two_test" src="/images/experiments/ending/make-decision/162631111-daf31f6f-156b-481e-aa01-f29743f7e20a.png" />
...
<img width="454" alt="Targeted layer parameter default switching to control value when targeting disabled" src="/images/experiments/ending/make-decision/162630927-e4b147a3-5b68-41d0-a439-f90ab001d737.png" />
...
<img width="454" alt="Layer override showing targeted users receiving shipped parameter while others keep default" src="/images/experiments/ending/make-decision/162634627-ae327d9e-81a9-42f9-8171-836808cb6ffb.png" />
...
<Frame>
  <img src="/images/experiments/ending/make-decision/549864e9-0509-4b44-a588-fd10ace1e365.png" alt="Make decision rollout options interface" />
</Frame>
...
<Frame>
  <img src="/images/experiments/ending/make-decision/f200b795-0442-49ed-8c13-e220b3a77a81.png" alt="Ship with rollout configuration screen" />
</Frame>
...
<Frame>
  <img src="/images/experiments/ending/make-decision/6fab7c0e-2566-4d14-bdb6-b94102fb08ac.png" alt="Automated rollout phases configuration dialog" />
</Frame>
...
<Frame>
  <img src="/images/experiments/ending/make-decision/f1fd04b3-e6a0-4e32-91a8-fb24279ab923.png" alt="Rollout schedule preview and commit interface" />
</Frame>
...
<img width="597" alt="Ship with holdback dialog specifying control percentage in Make Decision modal" src="/images/experiments/ending/make-decision/046fcb33-d4c0-4ca4-b58a-1c8e931b6161.png" />
...
4. Splitting the shipped group:
        ...
        - The size of Test segment will have the same percentage allocation as the holdback group for an [equal sized comparison](https://docs.statsig.com/experiments/holdouts-introduction#how-to-read-holdouts) of 50:50.
...
<img width="959" alt="Pulse results display separating test and launched segments when shipping with holdback" src="/images/experiments/ending/make-decision/48f999c5-f7d0-47fd-9af8-96512802d6cf.png" />
...
<img alt="Snapshot of original experiment when using ship with holdback" src="/images/experiments/ending/make-decision/ship_with_holdback.png" />
