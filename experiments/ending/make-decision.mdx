...
description: "Analyze Statsig experiment results and decide whether to launch, abandon, or continue an experiment based on metric impact and statistical confidence."
---
