...
description: "Abandon a Statsig experiment to stop all user assignments and clear targeting, including implications for downstream metrics and exposure data."
---
