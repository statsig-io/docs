...
1. Create a "Known Bots" Segment for your project:
    ...
    <Frame>
      <img src="/images/experiments/monitoring/bots/5bc62f62-7613-41d2-bcca-6f89f13baa3a.png" alt="Screenshot 2024-08-09 at 1 21 05 PM" />
    </Frame>
    ...
    <Frame>
      <img src="/images/experiments/monitoring/bots/97c1cdfe-9d65-42ae-acc7-ed47b583fce6.png" alt="Screenshot 2024-08-09 at 1 08 50 PM" />
    </Frame>
...
3. Apply the Segment to your Gates and Experiments:
    ...
    <Frame>
      <img src="/images/experiments/monitoring/bots/d6b51af0-ecfc-49c4-9e48-73bd276836ef.png" alt="Screenshot 2024-08-05 at 11 25 35 AM" />
    </Frame>

    For experiments, create a Conditional Override that forces units in this segment to receive whatever version you want.

    <Frame>
      <img src="/images/experiments/monitoring/bots/97ec1bcd-6f03-4b51-b0fe-9859f11559b1.png" alt="Screenshot 2024-08-05 at 11 17 32 AM" />
    </Frame>
