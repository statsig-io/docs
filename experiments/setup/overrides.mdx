...
description: "Override Statsig experiment group allocation for specific users or environments during development and QA, so testers see a chosen variant deterministically."
---
