...
description: "Use SPRT (Sequential Probability Ratio Test) methodology in Statsig for faster A/B test decision making without statistical penalties for peeking at results."
---
