...
description: "Learn how Bayesian A/B testing works in Statsig experiments, including informative priors, posterior probabilities, and implementation details for analysis."
---
...
<Frame>
  <img src="/images/experiments/advanced-setup/bayesian/c9c01a57-fe13-47a9-b734-20d6e8d715a4.png" alt="Bayesian experiment configuration interface" />
</Frame>

The experiment type cannot be modified once the experiment starts.

<Frame>
  <img src="/images/experiments/advanced-setup/bayesian/be912632-6200-4408-977c-92f48dfdd7bc.png" alt="Bayesian experiment type selection interface" />
</Frame>

Deep dive analysis should also reflect Bayesian statistics

<Frame>
  <img src="/images/experiments/advanced-setup/bayesian/c9214142-d11f-48c8-92a4-53581bbc498c.png" alt="Bayesian deep dive analysis interface" />
</Frame>
...
<Frame>
  <img src="/images/experiments/advanced-setup/bayesian/0aa0a52c-4f97-42af-82dd-4d26dd1de7c0.jpg" alt="Informative priors configuration interface" />
</Frame>
