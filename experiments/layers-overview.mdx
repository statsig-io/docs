---
title: Layers
description: Group related Statsig experiments into mutually exclusive layers so they share parameters and traffic allocation without redeploying application code.
---
