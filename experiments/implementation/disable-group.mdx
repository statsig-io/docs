...
description: "Disable poorly performing experiment groups in Statsig while keeping other variants running, so users see a safe fallback without stopping the test."
---
...
<Frame>
  <img src="/images/experiments/implementation/disable-group/disable_group.png" alt="Experiment overflow menu showing Disable a Group option" />
</Frame>
<Frame>
  <img src="/images/experiments/implementation/disable-group/disable_experiment_groups.png" alt="Disable group dialog listing experiment groups with toggles" />
</Frame>
