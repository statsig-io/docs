...
- New users will stop getting allocated to the disabled group
- Users already assigned to the disabled group will begin to receive the default experience
- Exposures for users already assigned to the disabled group will continue to be tracked
- Exposure imbalance (SRM) due to the disable group will not trigger health checks
...
<Frame>
  <img src="/images/experiments/implementation/disable-group/175094935-1dbb9b34-ebbe-467c-9a84-e61aeeb3180f.png" alt="Experiment overflow menu showing Disable a Group option" />
</Frame>
<Frame>
  <img src="/images/experiments/implementation/disable-group/175095107-2ef5d9e3-4c33-44ec-ac13-937f3b030149.png" alt="Disable group dialog listing experiment groups with toggles" />
</Frame>
...
<Frame>
  <img src="/images/experiments/implementation/disable-group/2fa3cb71-9a46-46f1-bb11-b8e7f07df9c6.png" alt="Menu option to disable or enable a group in experiment controls" />
</Frame>
<Frame>
  <img src="/images/experiments/implementation/disable-group/a56e7f14-53e9-4d41-8266-d70de1ec3ebf.png" alt="Modal showing reenable group selections" />
</Frame>
