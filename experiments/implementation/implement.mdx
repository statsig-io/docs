...
Once the experiment is enabled for a lower environment, the experment status will shift from “Not Started” to “Testing”.

<Frame>
  <img src="/images/experiments/lower_environment_results.png" alt="Lower environment resalt" />
</Frame>
...
The experiment enabled in lower environments can be resalted. This is helpful in the situation where a given user is looking to re-test the experiment E2E. 

<Frame>
  <img src="/images/experiments/lower_environment_resalt.png" alt="Lower environment resalt" />
</Frame>
