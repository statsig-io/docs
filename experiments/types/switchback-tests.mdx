...
<Frame>
  <img src="/images/experiments/types/switchback-tests/adf0e2b0-0e4c-47b9-8a04-d0f01f130f7c.png" alt="Bucket metrics table summarizing switchback exposures" />
</Frame>

For sum and count metrics, we use the mean value per unit exposed to that bucket.

<Frame>
  <img src="/images/experiments/types/switchback-tests/8f234be9-7848-46fa-a84d-6d6c7facf51b.png" alt="Metric detail view showing per-unit averages within a bucket" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/8239da03-6f94-47b0-b9b5-39e87566f7fc.png" alt="Formula showing ratio metric mean calculation across switchback buckets" />
</Frame>

The mean of a sum or count metric would be:

<Frame>
  <img src="/images/experiments/types/switchback-tests/220515f6-e0b0-4f64-a441-e5facdde5530.png" alt="Formula for sum or count metric averages in switchback tests" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/1fb290c9-f253-4be0-9bef-b212f74f6e0a.png" alt="Equation for treatment effect delta between test and control" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/bea68643-3ade-4daf-a6fa-79e39a7274d7.png" alt="Bootstrap confidence interval formula for switchback tests" />
</Frame>
...
<img width="495" alt="Experiment type menu selecting switchback test" src="/images/experiments/types/switchback-tests/359bcb6f-5cc4-4126-ac78-354c8f3b0474.png"/>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/a3e951fb-9a62-48be-9fec-59fcc2003d17.png" alt="Switchback targeting configuration showing gate and bucketing options" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/e53ea760-91c1-40e3-85fd-3da3d886d1ed.png" alt="Buckets configuration table listing predefined regions" />
</Frame>
...
<Info>
Randomized bucketing is an advanced feature, please reach out to our support team, your sales contact, or via our slack channel if you want this enabled.
</Info>

<Frame>
  <img src="/images/experiments/types/switchback-tests/3c79d1c1-8b15-401c-9635-6b3d4b08d416.png" alt="Randomized ID bucketing interface selecting custom ID" />
</Frame>
...
<img width="1019" alt="Switchback schedule editor specifying assignment windows and bucket starting phases" src="/images/experiments/types/switchback-tests/67ed1aee-f5aa-49b6-b684-a9919b59d5ca.png"/>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/657cce2d-22b0-41cf-8b43-2d3f05cfefb8.png" alt="Switchback experiment pulse results showing bucket-level metrics" />
</Frame>
