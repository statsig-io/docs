...
<Frame>
  <img src="/images/experiments/types/switchback-tests/adf0e2b0-0e4c-47b9-8a04-d0f01f130f7c.png" alt="Screen Shot 2023-09-27 at 11 46 19 AM" />
</Frame>

For sum and count metrics, we use the mean value per unit exposed to that bucket.

<Frame>
  <img src="/images/experiments/types/switchback-tests/8f234be9-7848-46fa-a84d-6d6c7facf51b.png" alt="Screen Shot 2023-09-27 at 11 46 42 AM" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/8239da03-6f94-47b0-b9b5-39e87566f7fc.png" alt="Screen Shot 2023-09-27 at 11 47 29 AM" />
</Frame>

The mean of a sum or count metric would be:

<Frame>
  <img src="/images/experiments/types/switchback-tests/220515f6-e0b0-4f64-a441-e5facdde5530.png" alt="Screen Shot 2023-09-27 at 11 47 59 AM" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/1fb290c9-f253-4be0-9bef-b212f74f6e0a.png" alt="Screen Shot 2023-09-27 at 11 48 35 AM" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/bea68643-3ade-4daf-a6fa-79e39a7274d7.png" alt="Screen Shot 2023-09-27 at 11 49 06 AM" />
</Frame>
...
<img width="495" alt="Screen Shot 2023-09-26 at 6 59 01 AM" src="/images/experiments/types/switchback-tests/359bcb6f-5cc4-4126-ac78-354c8f3b0474.png"/>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/a3e951fb-9a62-48be-9fec-59fcc2003d17.png" alt="Screen Shot 2023-10-04 at 3 12 05 PM" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/e53ea760-91c1-40e3-85fd-3da3d886d1ed.png" alt="Screen Shot 2023-10-04 at 11 44 26 AM" />
</Frame>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/3c79d1c1-8b15-401c-9635-6b3d4b08d416.png" alt="Screen Shot 2023-10-04 at 11 44 44 AM" />
</Frame>
...
<img width="1019" alt="Screen Shot 2023-09-26 at 6 50 36 AM" src="/images/experiments/types/switchback-tests/67ed1aee-f5aa-49b6-b684-a9919b59d5ca.png"/>
...
<Frame>
  <img src="/images/experiments/types/switchback-tests/657cce2d-22b0-41cf-8b43-2d3f05cfefb8.png" alt="Screen Shot 2023-09-27 at 10 30 21 AM" />
</Frame>