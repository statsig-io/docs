...
description: Statsig Web Analytics tracks visitors, sessions, journeys, errors, and site metrics for marketers and site owners familiar with tools like Google Analytics.
---
...
If using javascript client SDK or other frameworks, you can use the corresponding SDK with the autocapture plugin (JS, React, Angular, etc.):
...
![Metrics Explorer interface for analyzing web analytics data](/images/webanalytics/overview/f4ed6f2c-79ce-4e47-ba6d-8dbe69978cc0.png)
