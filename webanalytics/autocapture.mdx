...
description: Learn how Statsig autocapture collects web analytics events, the metadata attributes it records, and how to configure tracking in your application.
---
