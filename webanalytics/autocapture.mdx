...
description: Reference for Statsig web analytics autocapture, covering the events captured automatically, metadata attributes recorded, and SDK configuration options.
---
