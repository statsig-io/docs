...
description: "Manage the end-of-life for Statsig metrics through archiving and deletion options to keep your metrics catalog clean without breaking historical references."
---
...
<Frame>
  <img src="/images/metrics/archiving-metrics/215638876-3c2ae682-8db8-4dc7-9c14-3b4d7185f57e.png" alt="Bulk Archive" />
</Frame>

2) In the Metrics Detail View page, select the "..." in the upper right-hand corner, and select **Archive**. 
<Frame>
  <img src="/images/metrics/archiving-metrics/215639240-321b4e3f-d9c7-4f7d-ab77-9e18ba1c5867.png" alt="Archive" />
</Frame>

Once you select Archive, Statsig will check if this metric is used in any feature gates, experiments, or other metrics. 
<Frame>
  <img src="/images/metrics/archiving-metrics/215640348-b210eb9e-5475-4853-869f-7a9f66375f0a.png" alt="Archive dependencies" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/215640435-412375f7-398b-4bef-9495-cc20d1805769.png" alt="Archive Grace Period" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/215640543-7cb05d46-e61d-4cf4-a07c-eb76c9f50e36.png" alt="Archive after grace period" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/c7912507-636f-4f33-9555-70180dfd205e.png" alt="State graph" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/6f7eb3db-399a-45c8-be19-794e89dd349d.png" alt="Metric References" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/d7378d7b-a588-496b-ae35-24f38c6d5b6a.png" alt="Banner" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/2a570a92-76d6-41b3-aea5-ebdd53469856.png" alt="Dropdown" />
</Frame>

If you’d like to turn off auto-archiving entirely for your project, you may do so in the Project Settings page

<Frame>
  <img src="/images/metrics/archiving-metrics/74cd5575-e1bb-4f69-87f9-1feece5eb73f.png" alt="Project Settings" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/215641202-82f23bac-f620-4d4a-8c32-fe64a4ffc06c.png" alt="Delete metric" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/215641295-55c8dc10-7199-4505-ba0e-d02299fb371a.png" alt="Dependencies" />
</Frame>
...
<Frame>
  <img src="/images/metrics/archiving-metrics/215641634-1c70e688-0fe9-4cac-80bb-d3faeedcc0ed.png" alt="Undo delete" />
</Frame>
