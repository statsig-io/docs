...
description: "Get notified in Slack and email when Statsig experiments or feature rollouts cause metric regressions beyond preset thresholds so you can react quickly."
---
...
<img width="1508" alt="Metrics catalog entry showing alert configuration option" src="/images/metrics/rollout-alerts/205982663-f5eabaf6-733b-410f-bba1-63268f3af31a.png"/>
...
<img width="1430" alt="Metric alert creation panel specifying threshold, units, and subscribers" src="/images/metrics/rollout-alerts/205983421-a50e4373-29b7-4110-91de-a0246f87fe5d.png"/>
...
<Frame>
  <img src="/images/metrics/rollout-alerts/2a0434fe-e708-497d-b5bd-53c7b609cd47.png" alt="Scorecard showing metric delta preview with alert threshold guidance" />
</Frame>
...
<Frame>
  <img src="/images/metrics/rollout-alerts/a57599b6-044f-42b6-97fc-e6fb8bb3435c.png" alt="Metric trend hover showing detailed data point information" />
</Frame>

<Frame>
  <img src="/images/metrics/rollout-alerts/f4b0e8a2-c5aa-4bb3-b57d-36930e906e5d.png" alt="Metric time-series chart with selectable date range" />
</Frame>
...
<img width="609" alt="Alert notification card showing metric exceeding threshold" src="/images/metrics/rollout-alerts/205983664-14d2715d-924b-429e-b4a3-40365c4a26af.png"/>

<img width="752" alt="Slack notification preview for rollout alert" src="/images/metrics/rollout-alerts/205983817-6a569919-7e2b-4716-9862-aa406c9db843.png"/>
...
<img width="1474" alt="Diagnostics page showing call-to-action after alert triggers" src="/images/metrics/rollout-alerts/205983990-6ccbd888-acd4-47e3-96ef-8b3a513a26bf.png"/>
...
<img width="1473" alt="Rollout alerts section with resolve and snooze controls" src="/images/metrics/rollout-alerts/205984434-f60e7d21-8356-499d-95e8-0c551f82a74d.png"/>
...
<img width="1474" alt="Alert history table listing firing and resolution events" src="/images/metrics/rollout-alerts/205984564-216fdf30-185b-4b05-9047-b64769c844ec.png"/>

<img width="1054" alt="Alert resolution dialog capturing notes and snooze options" src="/images/metrics/rollout-alerts/205984591-cf528cab-c6bd-43a5-8aa1-c80704d4e137.png"/>
