...
description: "Configure metric directionality in Statsig so increases or decreases in metric values are correctly labeled positive or negative in experiment results."
---
...
<Frame>
  <img src="/images/metrics/directionality/fa0cbf9f-c84f-4db6-b9fa-84d672358a72.png" alt="Metric directionality configuration interface" />
</Frame>
