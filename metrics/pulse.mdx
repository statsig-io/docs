---
title: "Pulse Metrics"
description: "How different Statsig metric types are computed and interpreted in Pulse experiment results, including confidence intervals, lift, and significance flags."
---
...
<Frame>
  <img src="/images/metrics/pulse/aa7e1063-6473-4e4e-9ca4-7074f5a0c450.png" alt="pulse 1" />
</Frame>

<Frame>
  <img src="/images/metrics/pulse/7b0b1d99-c720-480e-8671-f5f696485500.png" alt="pulse 2" />
</Frame>
...
- [**event_count**](/metrics/raw-event-metrics#event-count-metric) measures the volume of the activity based on count of events triggered
- [**event_dau**](/metrics/raw-event-metrics#event-dau-metric) measures unique daily users who triggered a given event
...
<Frame>
  <img src="/images/metrics/pulse/187719553-c7e5c186-5dfe-4521-8bfb-1bb4b8cdb38d.png" alt="Event count and event DAU metrics table" />
</Frame>
...
<Frame>
  <img src="/images/metrics/pulse/187721781-3240ebc6-43ae-4fd8-ac44-c3493308e127.png" alt="Experiment metrics table showing total event count and mean values" />
</Frame>
...
<Frame>
  <img src="/images/metrics/pulse/187721834-b8e94f15-f3ee-4584-924b-96e424ddcd0c.png" alt="Event DAU metrics table showing daily participation rates" />
</Frame>
