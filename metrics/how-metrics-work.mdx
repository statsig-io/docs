...
However, when testing experiments in lower environments (such as development or staging), you can track cumulative exposures and metric results collected from those environments. This allows you to validate your experiment setup before launching to production but production data is prioritized for final Pulse analyses.
