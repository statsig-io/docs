---
title: "User Property"
description: "Break down Statsig experiment results by user properties like subscription tier, country, or platform to gain deeper insights into heterogeneous effects."
---
...
<Frame>
  <img src="/images/metrics/user-property/226679274-01705500-48ee-44d4-8a5c-cbc49d97d0b2.png" alt="User property configuration interface" />
</Frame>

You can run custom queries on your Pulse results (Explore tab) to group by or filter by these User Property.
<Frame>
  <img src="/images/metrics/user-property/226679816-5c7d393f-80e2-4670-8978-fc607b5fbe1a.png" alt="Pulse results custom query interface" />
</Frame>
