...
description: "Break down Statsig metrics into dimensions using event properties and metadata fields for detailed segment-level analysis in experiments and dashboards."
---
...
<Frame>
  <img src="/images/metrics/metric-dimensions/209886245-c26f569b-a4d4-4882-9d9c-f65f3c1ba43b.png" alt="Event property configuration" />
</Frame>
...
<Frame>
  <img src="/images/metrics/metric-dimensions/162332284-259ea614-8cb6-4c9d-aebd-3e41f9092a64.png" alt="Pulse results breakdown by product category" />
</Frame>
