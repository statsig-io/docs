...
description: "Count distinct metrics in Statsig compute approximate unique value counts at the unit level using HyperLogLog++ sketches for efficient scalable estimation."
---
