...
description: "Step-by-step guide to creating custom Daily Active User (DAU) metrics in Statsig tailored to your product definition of an active user and key actions."
---
