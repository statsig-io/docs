...
description: "Run Statsig experiment analysis when the assignment unit differs from the analysis unit, including how to configure cross-ID mappings and interpret results."
---
...
<Frame>
  <img src="/images/metrics/different-id/0b75615f-2b66-44f4-b6e0-e0bd3e555199.png" alt="Workflow diagram for analyzing metrics at different ID levels" />
</Frame>
...
<Frame>
  <img src="/images/metrics/different-id/a99a4577-8be5-4001-ac4d-2297f3b2fff0.png" alt="Metric source table setup with org_id and user_id fields" />
</Frame>

### 2. Choose your assignment source, where the unit of assignment is `org_id`.

<Frame>
  <img src="/images/metrics/different-id/16472cd7-1aa1-44a2-9a6b-0f789ac5308e.png" alt="Assignment source configuration selecting org_id unit" />
</Frame>
...
<Frame>
  <img src="/images/metrics/different-id/ca4c9076-28e1-4cf8-8aa1-2127def7d771.png" alt="Metric definition screenshot showing revenue per user_id formula" />
</Frame>

### 4. Set up the experiment with `org_id`

<Frame>
  <img src="/images/metrics/different-id/02f9c6bb-0b32-4caf-a529-5bacc2a56d44.png" alt="Experiment setup specifying org_id as unit type" />
</Frame>
