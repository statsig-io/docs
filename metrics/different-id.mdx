...
<Frame>
  <img src="/images/metrics/different-id/0b75615f-2b66-44f4-b6e0-e0bd3e555199.png" alt="Screenshot 2024-04-29 at 3 45 28 PM" />
</Frame>
...
<Frame>
  <img src="/images/metrics/different-id/a99a4577-8be5-4001-ac4d-2297f3b2fff0.png" alt="1 metric source" />
</Frame>

### 2. Choose your assignment source, where the unit of assignment is `org_id`.

<Frame>
  <img src="/images/metrics/different-id/16472cd7-1aa1-44a2-9a6b-0f789ac5308e.png" alt="2 assignment" />
</Frame>
...
<Frame>
  <img src="/images/metrics/different-id/ca4c9076-28e1-4cf8-8aa1-2127def7d771.png" alt="3a right" />
</Frame>

### 4. Set up the experiment with `org_id`

<Frame>
  <img src="/images/metrics/different-id/02f9c6bb-0b32-4caf-a529-5bacc2a56d44.png" alt="4 experiment" />
</Frame>
