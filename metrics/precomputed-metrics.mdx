...
description: "Import precomputed metrics from cloud data warehouses like Snowflake, BigQuery, and Redshift into Statsig for use in experiment analysis and scorecards."
---
...
<Frame>
  <img src="/images/metrics/ingest/178854882-730ef0d5-8eb2-4344-88ab-33111301e712.png" alt="Metrics logstream showing imported precomputed metrics" />
</Frame>
