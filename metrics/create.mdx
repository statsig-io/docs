...
description: "Create custom Statsig metrics from raw events using metric types such as event count, user count, sum, ratio, and funnel for experiment analysis."
---
