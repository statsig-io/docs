...
description: "Create custom Statsig metrics by filtering and aggregating events based on event metadata and properties, including value, country, and platform filters."
---
