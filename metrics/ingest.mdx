...
description: "Import precomputed metrics from Snowflake, BigQuery, Redshift, and other data warehouses into Statsig using built-in connector integrations and scheduled syncs."
---
...
<Frame>
  <img src="/images/metrics/ingest/178854882-730ef0d5-8eb2-4344-88ab-33111301e712.png" alt="Metrics catalog displaying logstream entries for ingested metrics" />
</Frame>
...
<Frame>
  <img src="/images/metrics/ingest/179048336-ebdde45b-17e7-47ad-bb81-01f8f032b978.png" alt="Metrics logstream UI showing isTest flag toggle" />
</Frame>
