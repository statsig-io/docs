...
Statsig automatically generates an "event_count" metric for each uniquely named **custom event** that you log. Auto-generated metrics are created from production environment events, and any newly logged custom event should have an event_count metric created within 24 hours of logging their first events. When testing experiments in lower environments, you can track cumulative exposures and metric results to validate your setup before launching to production.
...
<Frame>
  <img src="/images/metrics/raw-event-metrics/e4967643-33b4-46b6-9fca-5cee83f8f0a6.png" alt="Event metrics dashboard view" />
</Frame>
...
<Frame>
  <img src="/images/metrics/raw-event-metrics/4b7b30d6-d14d-4430-81a5-4fc467d466d2.png" alt="Event count metric configuration interface" />
</Frame>
...
<Frame>
  <img src="/images/metrics/raw-event-metrics/d22ff8d2-5aea-42b4-86e0-126c25678e15.png" alt="Metrics catalog interface" />
</Frame>
...
<Frame>
  <img src="/images/metrics/raw-event-metrics/008034e9-cce8-4e6f-bce1-84a789ac4a19.png" alt="Event DAU metric configuration interface" />
</Frame>
