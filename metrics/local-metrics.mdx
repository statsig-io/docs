---
title: "Local Metrics"
description: "Create local metrics scoped to a single Statsig experiment or feature gate without adding ad hoc metrics to the project-wide catalog."
---
...
<Frame>
  <img src="/images/metrics/local-metrics/2a249684-56a9-4c63-b2b2-7870efd89b76.png" alt="Setup tab showing + Create New Local Metric button" />
</Frame>
...
<Frame>
  <img src="/images/metrics/local-metrics/b718c3b7-9696-4af0-bbc5-48fef3cfa1d3.png" alt="Pulse scorecard with Edit Primary Metrics and Create New Local Metric options" />
</Frame>
...
<Frame>
  <img src="/images/metrics/local-metrics/452d9efe-2706-4d47-aee6-48c8f6288e8f.png" alt="Local metric creation wizard with event selection and filters" />
</Frame>
...
<Frame>
  <img src="/images/metrics/local-metrics/50bc5742-2f2a-4147-9cb3-70658d6391da.png" alt="Local metric placement selector for primary scorecard" />
</Frame>
<Frame>
  <img src="/images/metrics/local-metrics/ae3932df-f81b-4fed-9d23-b2b196ac83bc.png" alt="Monitoring metrics section showing new local metric entry" />
</Frame>
