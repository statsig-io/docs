---
title: "User Flows"
description: "Visualize customer journeys through your application using Statsig User Flows to see common paths users take and where they drop off between events."
---
...
8. Click on **Create** to finish
  ...
  <Frame>
    <img src="/images/metrics/create-user-flows/141128226-097e2441-e5ee-4e8d-8725-6d57d3fdeb83.png" alt="User flow creation interface" />
  </Frame>
