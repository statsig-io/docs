---
title: "Metric Family"
description: "Use metric families in Statsig to manage variants of the same underlying metric, like a daily, weekly, or windowed version, from one configuration entry."
---
