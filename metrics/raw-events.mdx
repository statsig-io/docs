...
## Billing
Statsig bills you for the [two types of raw events](/metrics/raw-events#types-of-raw-events) outlined above. We only bill for production environment events. While you can track cumulative exposures and metric results from lower environments when testing experiments, production data is prioritized for final Pulse analyses. 
