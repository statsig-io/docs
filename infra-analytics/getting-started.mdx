...
description: Set up OpenTelemetry exporters to send logs, metrics, and traces to Statsig Infra Analytics for use in Logs Explorer, Metrics Explorer, and alerts.
---
