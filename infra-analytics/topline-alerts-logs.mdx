...
description: 'Detect infrastructure regressions by evaluating logs in real time with Statsig topline alerts on log volume, error rates, and pattern-based thresholds.'
---
