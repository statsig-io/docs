...
description: 'Search and analyze all of your product's application logs in one place with Statsig Logs Explorer, including filtering, aggregations, and live tail mode.'
---
...
<Frame>
  <img src="/images/infra-analytics/lex-toggle.png" alt="Logs Explorer Switch Mode" />
</Frame>
