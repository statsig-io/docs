---
title: Updateuser
description: ```csharp // if you want to update the existing user, or change to a different user, call updateUser await StatsigClient.UpdateUser( new StatsigUser {
---
