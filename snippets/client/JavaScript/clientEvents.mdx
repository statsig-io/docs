---
title: Clientevents
description: Subscribe to Statsig client lifecycle events to respond to initialization, logging, or evaluation changes. ```tsx import type { AnyStatsigClientEvent,
---
