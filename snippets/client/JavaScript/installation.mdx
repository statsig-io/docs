---
title: Installation
description: To install the Statsig Web SDK, add the package via your preferred package manager. Include optional packages if you plan to enable Session Replay or 
---
