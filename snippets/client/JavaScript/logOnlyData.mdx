---
title: Logonlydata
description: Use `customUserCacheKeyFunc` with `updateUserSync` when you need to enrich a user locally without triggering a full network refresh. ```tsx const orig
---
