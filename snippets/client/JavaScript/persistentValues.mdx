...
description: Persist experiment assignments so users keep the same variant even if targeting rules change. ```tsx import { StatsigClient } from '@statsig/js-client
---
