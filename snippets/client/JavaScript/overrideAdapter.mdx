---
title: Overrideadapter
description: Use the `LocalOverrideAdapter` to define local overrides for gates, configs, experiments, or layers. ```tsx import { LocalOverrideAdapter } from '@sta
---
