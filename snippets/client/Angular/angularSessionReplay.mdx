---
title: Angularsessionreplay
description: import webAnalyticsIntro from '/snippets/client/webAnalytics.mdx' By including the [`@statsig/session-replay`](https://www.npmjs.com/package/@statsig/
---
