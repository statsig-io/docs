---
title: Angularsetup
description: The Statsig Angular bindings package provides a `StatsigService` that can be injected into your components. The way you provide and inject this servic
---
