---
title: Installation
description: <Info> If you need a starter project, follow the official <a href="https://react.dev/learn/build-a-react-app-from-scratch" target="_blank" rel="norefe
---
