---
title: Updateuser
description: Switch identities when a user logs in or when you collect richer attributes. ```tsx import { useGateValue, useStatsigUser } from '@statsig/react-bindi
---
