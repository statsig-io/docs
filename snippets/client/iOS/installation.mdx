---
title: Installation
description: To use the SDK in your project, you must add Statsig as a dependency. <Tabs> <Tab title="Swift Package Manager"> In your Xcode, select File > Swift Pa
---
