...
description: <ResponseField name="initTimeout" type="Double" default="3.0"> Used to decide how long the Statsig client waits for the initial network request to res
---
