---
title: Listening
description: In v1.14.0+, you can listen for SDK changes using `StatsigListening`. <CodeGroup> ```swift Swift class MyViewController: UIViewController, StatsigList
---
