---
title: Install
description: You can install the Statsig SDK by putting a script tag in the head of your HTML file: ```js <script src="https://cdn.jsdelivr.net/npm/@statsig/js-cli
---
