---
title: Aisetup
description: Setup Statsig in 90 seconds by copying this AI prompt into your IDE: ```text expandable Prompt You are a frontend engineer integrating the Statsig SDK
---

Setup Statsig in 90 seconds by copying this AI prompt into your IDE:

```text expandable Prompt
