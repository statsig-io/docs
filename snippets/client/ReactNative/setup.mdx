---
title: Setup
description: The setup for a ReactNative environment is very similar to a plain [React environment](/client/React). The only difference is that you need to use the
---
