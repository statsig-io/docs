---
title: Loadingstate
description: Dependent on your setup, you may want to wait for the latest values before checking a gate or experiment. If you are using the `StatsigProviderRN`, yo
---
