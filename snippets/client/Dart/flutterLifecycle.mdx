...
description: Due to the nature of mobile development, apps can be closed by the operating system when they are no longer in the foreground. To be sure that all eve
---
