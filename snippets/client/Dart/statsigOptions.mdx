...
description: <ResponseField name="initTimeout" type="int" default="3"> Used to decide how long (in seconds) the Statsig client waits for the initial network reques
---
