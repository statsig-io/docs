---
title: Setup
description: The setup for an Expo environment is very similar to a plain [React environment](/client/React). The only difference is that you need to use the Expo 
---
