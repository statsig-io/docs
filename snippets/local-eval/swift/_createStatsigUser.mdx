---
title:  Createstatsiguser
description: <CodeGroup> ```swift Swift let user = StatsigUser( userID: "a-user", customIDs: ["EmployeeID": "an-employee"], email: "user@statsig.io", ip: "58.84.23
---
