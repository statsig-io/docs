---
title:  Globaluser
description: To avoid needing to pass the user object to every single evaluation call, you can set a global user. This user will be used for all evaluations unless
---
