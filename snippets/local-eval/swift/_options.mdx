---
title:  Options
description: You can configure certain aspects of the SDKs behavior by passing a StatsigOptions object during initialization. <ResponseField name="eventQueueMaxSiz
---
