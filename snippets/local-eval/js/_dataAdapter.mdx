---
title:  Dataadapter
description: The `EvaluationsDataAdapter` type outlines how the `StatsigClient` should fetch and cache data during initialize and update operations. By default, th
---
