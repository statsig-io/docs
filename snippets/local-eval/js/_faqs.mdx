---
title:  Faqs
description: The SDK does not use any cookies. It does use the local storage for feature targeting and experimentation purposes only. Values for feature gates, dyn
---
