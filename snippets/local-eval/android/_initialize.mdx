---
title:  Initialize
description: <CodeGroup> ```java Java import com.statsig.androidlocalevalsdk.*; // ... android.app.Application app = // ref to your Application instance StatsigOpt
---
<CodeGroup>
...
This page explains synchronous initialization.
