---
title:  Postinitsyncing
description: By default, the SDK will only sync during initialization. If you would like to re-sync after initialization, you can call the `Statsig.client.updateAs
---
