---
title: Statsigusernotes
description: export const StatsigUserNotes = ({ sdkName }) => ( <> {sdkName && ( <Note> For the {sdkName} On-Device Evaluation SDK, you pass the `StatsigUser` obje
---
