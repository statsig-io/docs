...
description: Custom queries are a way to run additional custom experiment analyses on your existing data beyond what is in your main Results tab. You may run them 
---
...
<Frame>
<img width="467" alt="Custom query explore tab interface" src="/images/snippets/pulse/custom-queries/b2737ba1-dbf4-4235-a806-afea5dfe9a78.png" />
</Frame>
...
- **Metric Filter:** With metrics selected, you can filter metrics by either Event or User dimensions using the "Add Filter" dropdown. For example, if you wanted to look at your experiment results for Canadian users only, you could filter to "Country = CA".
  <Frame>
    <img src="/images/snippets/pulse/custom-queries/f56b4259-4d18-44d1-9646-9d7aa2f8f847.png" alt="Screenshot 2025-02-26 at 10 29 27 AM" />
  </Frame>
...
<img width="1378" alt="Screenshot 2025-06-08 at 10 33 05 PM" src="/images/snippets/pulse/custom-queries/85264260-2f65-4bfd-b4e1-477bd043b87d.png" />
...
<Frame>
<img width="1374" alt="Screenshot 2025-06-08 at 10 34 38 PM" src="/images/snippets/pulse/custom-queries/46574581-604e-4d29-b231-fa51876c813d.png" />
</Frame>
...
<Frame>
<img width="1378" alt="Screenshot 2025-06-08 at 10 35 21 PM" src="/images/snippets/pulse/custom-queries/56d11b46-f2de-4569-89f7-b0a439910964.png" />
</Frame>
<Frame>
<img width="505" alt="Scheduled query configuration interface" src="/images/snippets/pulse/custom-queries/fad0c8ce-3f9c-46be-a09c-52263e124259.png" />
</Frame>
...
<Frame>
  <img src="/images/snippets/pulse/custom-queries/df7c4087-82c3-41fb-8f5d-124094ec4526.png" alt="Sequential testing adjustments interface" />
</Frame>
