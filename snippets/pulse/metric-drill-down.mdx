...
description: A tooltip with key statistics and deeper information is shown if you hover over a metric in Pulse. <Frame> <img src="/images/snippets/pulse/metric-dri
---
...
<Frame>
  <img src="/images/snippets/pulse/metric-drill-down/767a8861-6034-4a60-966b-6d3ad94b843b.png" alt="Pulse drill-down analysis interface" />
</Frame>

- **Group**: The name of the group of users. For Feature Flags, the "Pass" group is considered the test group while the "Fail" group is the control. In Experiments, these will be the variant names.
