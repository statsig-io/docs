...
$$
Reverse Power = \frac{(Z_{1-\beta} + Z_{1-\alpha/2})}{\bar{X_{\text{control}}}}\times \sqrt{\frac{\mathrm{var}(X)}{\Delta \overline{N}}} \times 100\%
$$

For a one-sided test, the reverse power for a given metric X is computed using the following equation:

$$
Reverse Power = \frac{(Z_{1-\beta} + Z_{1-\alpha})}{\bar{X_{\text{control}}}}\times \sqrt{\frac{\mathrm{var}(X)}{\Delta \overline{N}}} \times 100\%
$$
