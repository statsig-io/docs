...
- **Experiment Delta (absolute)**: The absolute difference of the Mean between test groups i.e. Test Mean - Control Mean. The p-value is shown to indicate whether the observed difference is statistically significant.
