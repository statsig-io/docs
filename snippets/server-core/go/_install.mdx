---
title:  Install
description: via the `go get` CLI: You can install the latest version of the SDK: ``` go get github.com/statsig-io/statsig-server-core/statsig-go@latest ``` or a s
---
