---
title:  Paramstores
description: ```go // Get a Parameter Store by name s, _ := statsig.NewStatsig("secret-key", options) user := statsig.NewStatsigUserBuilder().WithUserID("a-user").
---
### Getting a Parameter Store

This page explains getting a parameter store.
