---
title:  Faqs
description: You may need to reset your environment variables to those found in the statsig.env or statsig.env.ps1 file which was generated during the post-install
---
