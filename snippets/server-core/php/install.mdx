---
title: Install
description: You can install the new PHP Core SDK using composer: ```shell composer require statsig/statsig-php-core ``` The PHP Core SDK uses the FFI extension to
---
