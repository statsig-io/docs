---
title: Installation
description: For PHP-core sdk you need to setup composer.json to **run post-install.php** file we provided <CodeGroup> ```bash PHP Core composer require statsig/st
---
