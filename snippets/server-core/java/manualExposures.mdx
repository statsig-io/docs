...
description: Manual exposures allow you to control when exposure events are logged. This is useful when you want to delay exposure logging until certain conditions
---
