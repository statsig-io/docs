---
title: Faqs
description: <AccordionGroup> <Accordion title="What Java versions are supported?"> The Java Core SDK supports Java 8 and higher. Java 8 support was added in versi
---
