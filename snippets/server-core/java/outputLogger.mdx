---
title: Outputlogger
description: Custom output logger allows you to redirect SDK logs to your own logging system. <CodeGroup> ```java Java import com.statsig.*; class MyOutputLogger i
---
