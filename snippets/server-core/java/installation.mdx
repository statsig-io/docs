---
title: Installation
description: - Java 8 or higher (Java 8 support added in version 0.4.3) - Compatible with all platforms listed in the Supported OS and Architecture Combinations se
---
