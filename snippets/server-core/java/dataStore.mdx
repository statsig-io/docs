---
title: Datastore
description: Data stores allow you to customize how the SDK fetches and caches feature specifications, enabling advanced use cases like using Redis or other distri
---
