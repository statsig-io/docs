---
title: Statsiguser
description: The `StatsigUser` object represents a user in your application and contains fields used for feature evaluation. <CodeGroup> ```java Java import com.st
---
