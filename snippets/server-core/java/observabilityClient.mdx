...
description: Observability client allows you to monitor SDK performance and emit custom metrics. <CodeGroup> ```java Java import com.statsig.*; class MyObservabili
---
