...
### Using spec_adapter_configs

```python
from statsig_python_core import StatsigOptions, SpecAdapterConfig

# Configure custom spec adapters
spec_adapter = SpecAdapterConfig(
    adapter_type="http",
    specs_url="https://custom-specs-endpoint.example.com/v1/download_config_specs",
    init_timeout_ms=5000
)

options = StatsigOptions()
options.spec_adapter_configs = [spec_adapter]
