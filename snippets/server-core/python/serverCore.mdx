---
title: Servercore
description: Statsig Server Core is a performance-focused rewrite of our server SDKs with a shared, core Rust library. With extensive optimization and Rust's inher
---
