---
title: Paramstores
description: ```python param_store = statsig.get_parameter_store(user, "my_parameter_store") ``` Parameter Store provides methods for retrieving values of differen
---
```python
# Get a Parameter Store by name

This page explains get a parameter store by name.
