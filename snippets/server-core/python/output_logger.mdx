---
title: Output Logger
description: The Output Logger Provider interface allows you to customize how the SDK logs internal messages. ```python class OutputLoggerProvider(OutputLoggerProv
---
