...
description: <Accordion title="EvaluationOptions"> `EvaluationOptions` allows you to customize the behavior of feature flag evaluations: ```csharp var options = ne
---
