---
title: Outputlogger
description: <AccordionGroup> <Accordion title="Logger Interface"> ```typescript interface OutputLoggerProvider { initialize?: () => void; debug?: (tag: string, me
---
<AccordionGroup>
...
This page explains implementation example.
