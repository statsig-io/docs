...
description: <Accordion title="StatsigOptions"> <ResponseField name="environment" type="string"> Environment parameter for evaluation. </ResponseField> <ResponseFi
---
<Accordion title="StatsigOptions">
### Parameters

This page explains parameters.
