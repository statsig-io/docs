---
title: Getexperiment
description: ```elixir user = %StatsigUser{ user_id: "test_user_123" } {:ok, layer} = Statsig.get_layer("user_promo_experiments", user) {:ok, title_string_value} =
---
```elixir
# Values via get_layer

This page explains values via get_layer.
