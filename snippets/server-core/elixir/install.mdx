---
title: Install
description: To use the SDK, add the following to your `mix.exs`: ```elixir {:statsig_elixir, "~> 0.8.0"}, ``` SDK is written using `rustler_precompiled`, which wi
---
...
This page explains set the environment variable.
