---
title: Options
description: <Accordion title="StatsigOptions"> <ResponseField name="environment" type="string"> The environment you're operating in (e.g., Production) </ResponseF
---
...
This page explains initialize statsigoptions with custom parameters.
