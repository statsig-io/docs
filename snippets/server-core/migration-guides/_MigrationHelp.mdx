---
title:  Migrationhelp
description: <Steps> <Step title="Add the new Dependencies"> - Add the new SDK package/module and any required platform-specific dependencies for your environment.
---
