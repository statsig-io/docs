---
title:  Globalchanges
description: <AccordionGroup> <Accordion title="User-Agent Parsing"> The SDK now uses a lightweight YAML-based User-Agent parser based on a reduced version of the 
---
## Behavioral Changes

This page explains behavioral changes.
...
To **disable** these features entirely, set the `StatsigOptions` flags {disableUserAgentParsing} and {disableCountryLookup}.
  </Accordion>
