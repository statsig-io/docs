---
title: Options
description: ```cpp statsig_cpp_core::StatsigOptionsBuilder optionsBuilder; ptionsBuilder.environment = "development"; ptionsBuilder.specs_url = api_v2 + "/downloa
---
```cpp
...
This page explains available options.
