...
description: A Bonferroni Correction is a statistical method that reduces the probability of false positives by adjusting the significance level for multiple compa
---
...
<Frame>
  <img
    src="/images/snippets/stats-methods/bonferroni-correction/038d75eb-5745-4587-b180-86b88594ccb9.png"
    alt="Bonferroni correction configuration interface"
  />
</Frame>
