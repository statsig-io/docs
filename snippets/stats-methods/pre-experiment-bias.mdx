...
description: In some cases, users in two experiment groups can have meaningfully different average behaviors before your experiment applies any intervention to the
---
...
<Frame>
  <img src="/images/snippets/stats-methods/pre-experiment-bias/246545035-22ff2db6-9c08-4227-a53d-8faa8feb5e92.png" alt="Pre-experiment bias visualization showing test group with consistently higher mean than control group" />
</Frame>
