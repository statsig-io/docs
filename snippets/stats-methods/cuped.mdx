---
title: Cuped
description: CUPED (short for Controlled-experiment Using Pre-Existing Data) is a technique which leverages user information from before an experiment to reduce th
---
...
See more at the [Variance Reduction](/snippets/stats-methods/variance-reduction) page.
