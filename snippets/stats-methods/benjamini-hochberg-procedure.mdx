...
description: The Benjamini-Hochberg Procedure ("BH" procedure) is a statistical method that reduces the probability of false positives by adjusting the significanc
---
...
<Frame>
  <img
    src="/images/snippets/stats-methods/benjamini-hochberg-procedure/c865494e-0ae4-489c-a416-45848b4d10bc.png"
    alt="Benjamini-Hochberg procedure configuration interface"
  />
</Frame>
