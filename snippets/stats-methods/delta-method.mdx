---
title: Delta Method
description: Statsig uses the delta method when calculating the variance for variables that have a numerator and denominator. The variance of ratio and mean metric
---
...
<Frame>
  <img src="/images/snippets/stats-methods/delta-method/167956015-cc3f9fca-2c4d-410c-bff1-3f13dd16d105.png" alt="Delta method variance formula" />
</Frame>
...
<Frame>
  <img src="/images/snippets/stats-methods/delta-method/167956127-c17017ef-07b2-4f76-88c4-00539eec50a7.png" alt="Covariance calculation formula" />
</Frame>
