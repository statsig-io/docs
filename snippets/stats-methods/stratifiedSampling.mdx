---
title: Stratifiedsampling
description: Stratified sampling involves dividing the entire population into homogeneous groups called strata (plural for stratum). Random samples are then select
---
...
<Frame>
  <img src="/images/snippets/stats-methods/stratifiedSampling/99f72b83-9f14-45a3-aa6e-ffcbd6211ec7.png" alt="Stratified sampling algorithm diagram" />
</Frame>
...
<Frame>
  <img src="/images/snippets/stats-methods/stratifiedSampling/0cfc499d-4fdf-44a8-ba2a-3537ba5bb904.png" alt="Stratified sampling metric selection interface" />
</Frame>
...
- On Statsig Warehouse Native, you'll use Entity Properties
  <Frame>
    <img src="/images/snippets/stats-methods/stratifiedSampling/102a839f-37fd-4443-807a-4b269f137490.png" alt="Entity properties configuration for stratified sampling" />
  </Frame>

Once you press the Stratify button, we'll analyze a set of salts and pick the best one.
<Frame>
  <img src="/images/snippets/stats-methods/stratifiedSampling/412f5c78-8c4f-4f16-88d3-60d3d3555ffd.png" alt="Stratification analysis results interface" />
</Frame>
...
<Frame>
  <img src="/images/snippets/stats-methods/stratifiedSampling/230964234-8cc81f66-f4f8-4f37-b6df-6d36d0d7ab98.png" alt="Manual assignment override configuration" />
</Frame>
