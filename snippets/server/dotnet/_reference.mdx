---
title:  Reference
description: ```csharp public class StatsigUser { public string? UserID public string? Email public string? IPAddress public string? UserAgent public string? Count
---
### Type StatsigUser

This page explains type statsiguser.
