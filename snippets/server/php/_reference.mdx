---
title:  Reference
description: ```java class StatsigUser { static function withUserID(string $user_id): StatsigUser static function withCustomIDs(array $custom_ids): StatsigUser fun
---
### Class: StatsigUser

This page explains class: statsiguser.
