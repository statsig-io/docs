---
title: Installation
description: You can install the PHP SDK using composer. ```bash composer require statsig/statsigsdk ``` The SDK is also [open source and hosted on github](https:/
---
