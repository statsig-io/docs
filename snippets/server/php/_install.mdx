---
title:  Install
description: You can install the PHP SDK using composer. ```shell composer require statsig/statsigsdk ``` The SDK is also [open source and hosted on github](https:
---
