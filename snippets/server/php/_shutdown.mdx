---
title:  Shutdown
description: Because we batch and periodically flush events, some events may still be in memory when your app/server shuts down. To make sure all logged events are
---
