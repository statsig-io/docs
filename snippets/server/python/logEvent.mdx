---
title: Logevent
description: ```python from statsig.statsig_user import StatsigUser from statsig.statsig_event import StatsigEvent statsig.log_event(StatsigEvent(StatsigUser("user
---
