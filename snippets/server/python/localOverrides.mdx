...
description: ```python statsig.override_gate("a_gate_name", true, "a_user_id") statsig.remove_gate_override("a_gate_name", "a_user_id") statsig.override_config("a_
---
```python
# Adding/Removing gate overrides

This page explains adding/removing gate overrides.
