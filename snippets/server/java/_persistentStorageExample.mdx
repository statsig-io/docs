---
title:  Persistentstorageexample
description: ```kotlin class KongUserPersistedStorageAdapter() : IUserPersistentStorage { private var value: MutableMap<String, UserPersistedValues> = mutableMapOf
---
