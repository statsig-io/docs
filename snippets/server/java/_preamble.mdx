---
title:  Preamble
description: :::info Server vs. Client These docs are for using our Java/Kotlin SDK in a multi-user, server side context. For client side android applications, che
---
