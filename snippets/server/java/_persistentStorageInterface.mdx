---
title:  Persistentstorageinterface
description: ```kotlin typealias UserPersistedValues = Map<String, StickyValues> interface IUserPersistentStorage { /** * Returns the full map of persisted values 
---
