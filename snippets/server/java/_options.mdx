---
title:  Options
description: import LocalModeSnippet from '/snippets/server/localModeSnippet.mdx' You can pass in an optional parameter `options` in addition to the server secret 
---
