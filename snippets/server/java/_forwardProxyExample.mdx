---
title:  Forwardproxyexample
description: <Tabs> <Tab title="Java"> ```java String address = "0.0.0.0:50051"; Map<NetworkEndpoint, ForwardProxyConfig> proxyConfigs = new HashMap(); proxyConfig
---
