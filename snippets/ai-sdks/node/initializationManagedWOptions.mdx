...
description: Optionally, you can configure [StatsigOptions](/server-core/node-core#statsig-options) for your Statsig instance: ```js import { StatsigAI, StatsigAIO
---
