---
title: Initializationmanagedwoptions
description: Optionally, you can configure [StatsigOptions](/server-core/python-core#statsig-options) for your Statsig instance: ```python from statsig_ai import S
---
...
This page explains if you want to configure any statsig options, this is optional:.
