...
description: After installation, initialize the SDK with a [Server Secret Key from the Statsig console](https://console.statsig.com/api_keys). <Warning> Server Sec
---
