---
title: Criteria Cost Breakdown
description: Cost impact of conditions, operators, and value counts used in gate evaluation.
---
...
| BROWSER_VERSION | High     | Requires user agent parsing                     |
...
These costs are applied based on the **operator** used in a condition. If a condition is not listed, it does not significantly impact SDK evaluation speeds.
...
| NOT_ARRAY_CONTAINS_ALL          | Low    | Requires scanning array values          |
