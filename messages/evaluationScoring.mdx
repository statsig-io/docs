...
description: "Troubleshooting reference for Statsig evaluation scoring messages in the console, including diagnostics for SDK health and evaluation correctness."
---
