...
last_update:
  date: 2025-09-18
description: Initialization is the step in SDK setup where your SDK downloads the values for your set of Flags(Gates), Experiments, Dynamic Configs, etc., and prep
---
