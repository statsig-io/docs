...
- `Limit flush`: flushes when a full batch is reached and backoff is satisfied. Limit flush performs opportunistic draining. Limit flush will keep flushing as long as each send over network is succesful. It will fall into backoff upon failure. 
