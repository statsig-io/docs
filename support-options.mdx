...
| Customer members access to Private Slack channel with Statsig engineers<sup>1</sup> | No | Limited | Up to 4 members |
| Critical/High Priority support with 4 hour response time during Statsig business hours<sup>2</sup>  | No | No | Yes |
