...
last_update:
  date: 2025-09-18
description: CURE (variance Control Using Regression Estimates) is Statsig's extended implementation of [CUPED](/experiments/statistical-methods/methodologies/cupe
---
