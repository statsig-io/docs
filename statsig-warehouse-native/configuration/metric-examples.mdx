...
description: "Example metric definitions in Statsig Warehouse Native, including SQL snippets and metric source mappings for common product, revenue, and engagement metrics."
...
<Frame>
  <img src="/images/whn/metric_examples_configuration.png" alt="Metric source setup specifying table path and date partition" />
</Frame>
...
<Frame>
  <img src="/images/whn/metric_examples_initials.png" alt="Timestamp and ID type configuration with revenue alias" />
</Frame>
...
<Frame>
  <img src="/images/whn/metric_examples_create_revenue.png" alt="Create metric dialog selecting revenue source" />
</Frame>

<Frame>
  <img src="/images/whn/metric_examples_configure_revenue.png" alt="Sum metric configuration for revenue column" />
</Frame>
...
<Frame>
  <img src="/images/whn/metric_examples_configuration.png" alt="Inline description explaining aggregation behavior" />
</Frame>
...
<Frame>
  <img src="/images/whn/metric_examples_create_account.png" alt="Create metric form for latest account value" />
</Frame>

<Frame>
  <img src="/images/whn/metric_examples_configure_account.png" alt="Latest value metric configuration using account column" />
</Frame>
...
Statsig provides a description of this in-product for any user who wants to learn more: 
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/7fe6af8f-02a9-45f4-ae3f-5c682757e571.png" alt="Product tooltip describing latest value aggregation logic" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/148469b7-df7b-4f39-af87-1ee9dd5ee431.png" alt="Event table metric source definition for participation rate" />
</Frame>
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/5bd9fcc7-54e1-4a15-a8c4-8d9950631d24.png" alt="ID type configuration for participation event data" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/04712a16-8dac-4c1f-a327-1854fd15d2aa.png" alt="Unit count metric creation with filters for specific event" />
</Frame> 
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/959c5dbd-eecf-4797-bc87-7970ccda4947.png" alt="Metric source selection during creation flow" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/0632de2f-dc8c-44c0-85c1-39e8a6a6f070.png" alt="Rollup mode options for participation metrics" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/76c815a1-14a6-4d8c-853e-10460f38d4a6.png" alt="Average session count metric configuration" />
</Frame>

Then, you cam define your funnel steps, specifying the sequence of events users go through.

<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/91d50945-ba23-47d0-b0e4-85308a0e404c.png" alt="Example showing multi-event participation configuration" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/a6de4690-83ad-49ed-af9a-4eef9c6a9700.png" alt="Metric filters applied to isolate specific event values" />
</Frame>
...
Statsig provides a description of this in-product for any user who wants to learn more: 
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/84c22973-af41-495d-a943-f0f7436050ee.png" alt="Metric catalog entry summarizing event-based conversion metric" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/e418815e-505c-4356-9922-d706bebb053c.png" alt="Configuration UI for retention-style rollup" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/d3e12922-3767-4a05-987b-e16df126ea41.png" alt="Metric details view describing rollup logic" />
</Frame>

In the Advanced Settings, you can configure what's the ID type for your retention metric. 
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/cdf184a4-cd3a-4622-8669-0d029b1e76dc.png" alt="Metric result example for session count" />
</Frame>
...
Statsig provides a description of this in-product for any user who wants to learn more:
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metric-examples/94843265-ed43-4bce-954f-3f64ec2d380f.png" alt="Example of metric insight card for participation rate" />
</Frame>
