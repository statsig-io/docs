---
title: Macros
description: "Reference for Statsig Warehouse Native query tools that help you inspect generated SQL, debug data sources, and validate metric and experiment configuration."
sidebarTitle: Macros
keywords:
  - owner:vm
last_update:
