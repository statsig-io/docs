...
last_update:
  date: 2025-09-18
description: In **Metric** and **Assignment sources**, you can use Statsig Macros to directly inject a DATE() type which will be relative to the experiment period 
---
