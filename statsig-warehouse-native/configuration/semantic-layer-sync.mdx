...
description: "Sync metric definitions from your semantic layer or dbt project into Statsig Warehouse Native to reuse existing business logic in experiments."
