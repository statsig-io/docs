...
description: Use Entity Properties in Statsig Warehouse Native to attach categorical attributes to experiment units for filtering and grouping results in Explore.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
