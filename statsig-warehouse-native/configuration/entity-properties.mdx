...
description: Entity properties are categorical attributes of users or other entities you can reuse across experiments to filter or group results in the Explore section.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
