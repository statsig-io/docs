...
last_update:
  date: 2025-09-18
description: Metrics are measures of user or system behavior that are used as evaluation criteria for experiments and for performing analysis. Metrics are organize
---
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/8cc2781c-23ac-46d2-b270-0d5d359c8f5b.png" alt="Screenshot 2024-06-12 at 11 31 44 AM" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/fb7526f9-3ffa-4192-8184-1388e3e80db9.png" alt="Screen Shot 2025-05-22 at 2 51 48 PM" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/f7023ab8-9d3d-4013-8595-b51325b7c954.png" alt="Screen Shot 2025-05-22 at 2 52 05 PM" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/94d40316-53bf-484e-8a73-57cc42e22ca6.png" alt="Screen Shot 2025-05-22 at 2 52 13 PM" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/cc73bf53-13ec-44f3-aa2c-606db4a8d4da.png" alt="Screen Shot 2025-05-22 at 2 54 10 PM" />
</Frame>
...
Without a well-managed Metric Catalog, it's hard to trust results as users don't understand if they can trust a metric, or the nuances of how it's defined. Statsig helps you solve this with a variety of tools:
