...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/8cc2781c-23ac-46d2-b270-0d5d359c8f5b.png" alt="Metrics catalog dashboard" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/fb7526f9-3ffa-4192-8184-1388e3e80db9.png" alt="Metric creation flow with aggregation and filters" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/f7023ab8-9d3d-4013-8595-b51325b7c954.png" alt="Metric detail page showing definition and timeseries" />
</Frame>

In the [insights tab](/aggregated-impact/) and in [meta-analysis](/experiments/exploring-results/meta-analysis), you can perform more detailed analysis of how experiments have impacted a metric, and how the metric relates to other metrics in your catalog.

<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/94d40316-53bf-484e-8a73-57cc42e22ca6.png" alt="Insights view summarizing aggregated impact" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/metrics/cc73bf53-13ec-44f3-aa2c-606db4a8d4da.png" alt="Reload metric data button and schedule settings" />
</Frame>
