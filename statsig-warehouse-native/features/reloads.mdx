...
last_update:
  date: 2025-09-18
description: Statsig's experimentation engine runs the necessary setup, diagnostics, and transformations required to generate the data points that power statistica
---
...
<Frame>
  <img src="/images/statsig-warehouse-native/features/reloads/f6c1aa47-8d6e-4b21-96ac-f2281d0d0491.png" alt="Pulse Load Controls" />
</Frame>
