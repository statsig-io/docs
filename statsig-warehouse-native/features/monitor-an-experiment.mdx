...
description: Use Experiment Diagnostics in Statsig Warehouse Native to monitor exposure volume, sample ratios, and data health throughout an experiment's run.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
...
- **Experiment Health Checks** show alerts for problems with the experiment setup. Hover over the icon and click on a check for more details.
  ...
  <Frame>
    <img src="/images/statsig-warehouse-native/features/monitor-an-experiment/8b557e40-2473-45e1-ac0c-bd61a2eb5208.png" alt="Diagnostic health check image" />
  </Frame>
