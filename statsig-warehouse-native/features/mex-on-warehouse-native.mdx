...
description: "Use Metrics Explorer (MEX) on Statsig Warehouse Native to slice metric data by dimensions, time period, and user properties for ad hoc analysis."
