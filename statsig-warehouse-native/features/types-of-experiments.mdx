...
description: Reference for the experiment types supported in Statsig Warehouse Native, including A/B tests, holdouts, switchbacks, geo-tests, and pre-post analyses.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
