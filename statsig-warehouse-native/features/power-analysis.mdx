...
- **Fixed Allocation or Fixed MDE Analysis**: Different types of analyses you want to run. See [here](/experiments-plus/power-analysis/#analysis-types) for more details.
