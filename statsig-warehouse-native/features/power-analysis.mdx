...
description: Use power analysis in Statsig Warehouse Native to estimate the sample size and duration needed to detect a target effect size with statistical confidence.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
...
<Frame>
  <img src="/images/statsig-warehouse-native/features/power-analysis/563ee87d-e16a-4649-b50a-628e32acca34.png" alt="Power Analysis UI" />
</Frame>
