...
description: "Common Statsig Warehouse Native use cases, including A/B testing on top of an existing warehouse, observational analysis, and metric exploration."
...
<Frame>
  <img src="/images/statsig-warehouse-native/features/use-case/76f83c44-0389-4441-a5fc-bf29b9cab119.png" alt="Experiment setup advanced settings selecting secondary ID" />
</Frame>

#### Step 2 - Identify the mapping mode that suits your need 
<Frame>
  <img src="/images/statsig-warehouse-native/features/use-case/e49a030e-4933-4019-80f3-812c46cdd493.png" alt="ID resolution mapping mode options" />
</Frame>

#### Step 3 - Choose your Entity Property Source 
<Frame><img width="1014" alt="Entity property source selection for ID mapping" src="/images/statsig-warehouse-native/features/use-case/abceaaf3-b15d-481e-9e7f-abc8a5c2cef3.png" /></Frame>
