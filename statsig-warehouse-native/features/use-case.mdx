...
last_update:
  date: 2025-09-18
description: I want to filter the experiment results to new users only: A user is 'new' if they had never visited the website before they were exposed to this expe
---
...
<Frame>
  <img src="/images/statsig-warehouse-native/features/use-case/76f83c44-0389-4441-a5fc-bf29b9cab119.png" alt="Screenshot 2025-01-27 at 11 44 05 AM" />
</Frame>

#### Step 2 - Identify the mapping mode that suits your need 
<Frame>
  <img src="/images/statsig-warehouse-native/features/use-case/e49a030e-4933-4019-80f3-812c46cdd493.png" alt="Screenshot 2025-01-27 at 11 47 59 AM" />
</Frame>

#### Step 3 - Choose your Entity Property Source 
<Frame><img width="1014" alt="Screenshot 2025-01-27 at 4 51 47 PM" src="/images/statsig-warehouse-native/features/use-case/abceaaf3-b15d-481e-9e7f-abc8a5c2cef3.png" /></Frame>
