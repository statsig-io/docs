...
last_update:
  date: 2025-09-18
description: Running statistical analysis for an experiment can be complex. Much of this complexity is abstracted away from the user, but this commonly leads t
---

Running statistical analysis for an experiment can be complex. Much of this complexity is abstracted away from the user, but this commonly leads to questions - things like:
