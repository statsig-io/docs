...
When not using [turbo mode](/statsig-warehouse-native/features/turbo), or when using [turbo mode](/statsig-warehouse-native/features/turbo) with incremental reloads, the date picker next to pulse can be used to view pulse "as of" a certain date. This is useful for understanding historical discussion of an experiment, or for understanding how results have evolved over time. This data can also be viewed through the lens of the time series views in Statsig.
