...
description: Use funnel metrics in Statsig Warehouse Native to understand multi-step user journeys and measure conversion rate impact between treatment groups.
