...
last_update:
  date: 2025-09-18
description: Full reloads will completely wipe the Staging/Results Datasets Statsig has used for previous pulse calculations, and Statsig will recalculate results 
---
