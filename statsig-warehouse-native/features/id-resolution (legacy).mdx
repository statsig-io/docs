...
description: Legacy ID resolution behavior in Statsig Warehouse Native for mapping cross-platform IDs and analyzing anonymous user experiments before the November update.
keywords:
  - owner:vm
last_update:
  date: 2025-10-21
