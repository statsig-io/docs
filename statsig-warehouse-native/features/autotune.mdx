...
last_update:
  date: 2025-09-18
description: Autotune Experiments in Warehouse Native have a very similar setup to cloud [Autotunes](/autotune/overview). In Warehouse Native, Autotune success eve
---
...
6. Select your Metric Source that you defined earlier as shown in the following example.

<Frame>
  <img src="/images/statsig-warehouse-native/features/autotune/857371e2-22e4-4316-bca0-b310f541b5c3.png" alt="Autotune metric source configuration interface" />
</Frame>
