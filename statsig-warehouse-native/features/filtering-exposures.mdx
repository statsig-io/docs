...
description: "Filter experiment exposures in Statsig Warehouse Native by user property, qualifying event, or time window to focus analysis on relevant subpopulations."
...
<Frame>
  <img src="/images/statsig-warehouse-native/features/filtering-exposures/f7a5ee06-b67a-4cba-9680-fbe99c64d0fc.png" alt="Qualifying event filter configuration interface" />
</Frame>
...
<img width="1169" alt="Assignment source filter selection UI" src="/images/statsig-warehouse-native/features/filtering-exposures/36ddb74f-d9e9-4e25-8349-61077f77b863.png" />
