...
last_update:
  date: 2025-09-18
description: You can use Qualifying Events to filter exposures to units who did or did not trigger an event after being exposed. This is a powerful tool, especiall
---
...
<Frame>
  <img src="/images/statsig-warehouse-native/features/filtering-exposures/f7a5ee06-b67a-4cba-9680-fbe99c64d0fc.png" alt="Screenshot 2024-06-11 at 4 18 32 PM" />
</Frame>
...
<img width="1169" alt="Screen Shot 2025-05-15 at 9 43 36 PM" src="/images/statsig-warehouse-native/features/filtering-exposures/36ddb74f-d9e9-4e25-8349-61077f77b863.png" />
