...
description: Use Entity Properties in Statsig Warehouse Native to provide additional categorical details about an entity for filtering and grouping experiment results.
