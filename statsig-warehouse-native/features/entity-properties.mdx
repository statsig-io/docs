...
description: Use entity properties in Statsig Warehouse Native to attach categorical attributes to users or other entities for filtering and grouping experiment results.
...
<Frame>
  <img src="/images/statsig-warehouse-native/configuration/entity-properties/6c151cf4-d343-4750-8bfd-a6d48afd6e10.png" alt="Entity properties setup form" />
</Frame>
