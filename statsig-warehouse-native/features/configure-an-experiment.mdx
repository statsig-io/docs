...
last_update:
  date: 2025-09-18
description: Setting up an experiment is a core flow in Statsig. In Warehouse Native, there's two modes to setting up an experiment. In one, you'll connect to exis
---
...
<Note>
Once you configure this value, it will overwrite the choice for `only include units with a completed duration` (refer to the relevant section)
</Note>
