...
title: Mean Metrics
sidebarTitle: Mean
description: Mean metrics in Statsig Warehouse Native calculate the average value of a numeric column from a metric source per unit for experiment analysis.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
