...
sidebarTitle: Unit Count (Latest Value)
description: Unit count metrics with the latest rollup type in Statsig Warehouse Native measure whether a unit performed an action on the most recent observed day.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
