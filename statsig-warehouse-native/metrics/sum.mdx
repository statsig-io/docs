...
title: Sum Metrics
sidebarTitle: Sum
description: Sum metrics in Statsig Warehouse Native calculate the total of a numeric column from a metric source per unit, used to compare treatment groups in experiments.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
