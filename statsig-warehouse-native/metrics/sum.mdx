...
title: Sum Metrics
sidebarTitle: Sum
description: Sum metrics in Statsig Warehouse Native calculate the sum of a numeric column from a metric source per unit, aggregated across experimental units.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
