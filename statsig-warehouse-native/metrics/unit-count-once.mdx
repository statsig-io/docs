...
sidebarTitle: Unit Count (One-Time Event)
description: Unit count metrics with the one-time event rollup type measure if a unit performed an action any time after being exposed to the experiment.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
