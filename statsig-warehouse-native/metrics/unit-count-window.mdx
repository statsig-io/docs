...
sidebarTitle: Unit Count (Window)
description: Unit count metrics with the windowed event rollup type measure if a unit performed an action in a specific period of time after first being exposed to the experiment.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
