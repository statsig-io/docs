...
description: Windowed unit count metrics in Warehouse Native measure whether a unit performed an action within a defined time window after experiment exposure.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
