...
description: Unit count windowed metrics measure whether a unit performed an action within a defined time window after first exposure to a Statsig experiment.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
