...
sidebarTitle: Unit Count (Daily Participation)
description: Unit count metrics with the daily participation rate rollup type measure the fraction of days that the user participated in an action during the experiment.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
