...
description: Count distinct metrics calculate the number of unique values in a metric source column, computed per-unit so the total reflects unique unit-value pairs.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
