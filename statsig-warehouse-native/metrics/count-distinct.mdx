...
description: Count Distinct metrics in Warehouse Native measure unique values in a metric source column per unit, totaling the unique unit-value pairs observed.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
