...
<Frame>
  <img src="/images/statsig-warehouse-native/metrics/retention/cce09282-0a9b-4218-b823-7416f03ef387.png" alt="Retention Setup" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/metrics/retention/2a9d8731-1c28-4c59-a0fe-3c1e7586c129.gif" alt="Retention Explanation" />
</Frame>
...
Retention metrics are [ratio metrics](/statsig-warehouse-native/metrics/ratio) for the purposes of pulse calculations; the only distinction is that the metric date is attributed to the denominator date.
