...
title: Count Metrics
sidebarTitle: Count
description: Count metrics in Statsig Warehouse Native count the number of records in a metric source, per unit and aggregated across experimental units for analysis.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
