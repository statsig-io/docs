...
title: Log Metrics
sidebarTitle: Log
description: Log metrics in Warehouse Native apply a logarithm to unit-level values from Sum or Count metrics before calculating Pulse results, reducing variance.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
