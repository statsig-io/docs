...
title: Ratio Metrics
sidebarTitle: Ratio
description: Ratio metrics in Statsig Warehouse Native measure the ratio of two underlying metrics (Count, Sum, Count Distinct, or Unit Count) for experiment analysis.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
