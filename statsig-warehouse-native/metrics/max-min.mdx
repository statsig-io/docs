...
description: Max and Min metrics in Statsig Warehouse Native calculate the largest or smallest value of a metric source column at the unit level for experiment analysis.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
