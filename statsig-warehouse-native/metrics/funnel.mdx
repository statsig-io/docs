---
title: Funnel++
description: "Funnel metrics in Statsig Warehouse Native measure conversion rates through a defined sequence of steps for multi-step user journey analysis."
sidebarTitle: Funnel++
keywords:
  - owner:vm
last_update:
