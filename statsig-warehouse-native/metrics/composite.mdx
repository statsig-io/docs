...
description: "Composite metrics in Statsig Warehouse Native combine two or more aggregated metric sources by addition or subtraction to produce a single result."
