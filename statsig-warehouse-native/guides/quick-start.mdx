...
description: "Quick start guide for Statsig Warehouse Native: connect your warehouse, define a metric source, run an A/A test, and analyze your first results."
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/66229d92-99a8-45c6-9a1c-7f8585465338.png" alt="Create metric source button" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/c0982d71-71c5-4899-bed9-a72c7db59515.png" alt="Metric source configuration mapping timestamp and user ID" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/8b997a0c-22e9-409d-8918-d21a95af1367.png" alt="Metrics catalog create button" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/fe0e4c5d-e2a6-4943-9b09-cb81dbadee9e.png" alt="Create assignment source page" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/08e3f20c-1590-4b08-ad60-fa96ecbf15cb.png" alt="Assignment source query configuration" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/8be2f079-4440-4742-9727-08e25b65c84b.png" alt="Detected experiments table" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/fc6e7092-b621-494a-bedb-8cd03a64d510.png" alt="Experiment creation wizard" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/287bc60b-23a6-4681-ac26-282ce8b88c13.png" alt="Experiment setup selecting metrics and group split" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/38f4f438-2592-44cb-9063-d3bc97da404b.png" alt="Experiment results showing hypothesis and exposures" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/quick-start/33e5fc2a-9b36-43f9-a6c2-2936867a7980.png" alt="Detailed metric lift view with significance" />
</Frame>
