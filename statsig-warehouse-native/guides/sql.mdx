...
last_update:
  date: 2025-09-18
description: Statsig Warehouse Native runs SQL in your warehouse to generate the experiment results, and the queries are fully transparent and made visible in cons
---
...
<Frame>
  <img src="/images/statsig-warehouse-native/guides/sql/f34e1265-e303-4705-b8cd-1a170a2af91e.png" alt="Pulse view SQL query details interface" />
</Frame>
