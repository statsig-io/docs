...
description: How to estimate, monitor, and reduce warehouse compute costs when running experiments in Statsig Warehouse Native, including Turbo Mode and pipeline tuning.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
...
<Frame>
<img width="1209" alt="Pipeline History" src="/images/statsig-warehouse-native/guides/costs/d2009b64-bbf6-49bf-a3a0-df04b0b89619.png" />
</Frame>
...
<Frame>
<img width="1299" alt="Pipeline Overview" src="/images/statsig-warehouse-native/guides/costs/0c1a1098-d345-458b-b7a0-2cc8bfc1ccfc.png" />
</Frame>
...
The [best practices](/statsig-warehouse-native/guides/best-practices) cover most situations that lead to high warehouse costs on Statsig. In short, you should aim to:
