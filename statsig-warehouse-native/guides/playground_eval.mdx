...
last_update:
  date: 2025-09-18
description: <Info> Playground evaluations are only recommended for Enterprise-tier customers. </Info> Many customers evaluating Statsig have sensitive data & long
---
