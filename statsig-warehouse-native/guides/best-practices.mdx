...
description: Best practices for modeling data, structuring metric sources, configuring assignment, and managing costs when running experiments in Statsig Warehouse Native.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
...
See [Compute Cost Transparency](/statsig-warehouse-native/guides/best-practices#compute-cost-transparency) to understand how much compute time your experiments use.
