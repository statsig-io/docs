...
description: How Statsig Warehouse Native handles data egress, privacy, and storage, including what data leaves your warehouse, what is stored, and how access is controlled.
keywords:
  - owner:vm
last_update:
  date: 2025-09-18
...
<Frame>
  <img src="/images/statsig-warehouse-native/analysis-tools/data-privacy/264110212-b9e07098-cd3a-4107-aa3f-6740fc3d8b7a.png" alt="Analysis Flow" />
</Frame>
