...
last_update:
  date: 2025-09-18
description: To set up connection with Microsoft Fabric, you must start from the [Fabric Workload Hub](https://app.fabric.microsoft.com/workloadhub/detail/Statsig.
---
...
<Frame>
  <img src="/images/statsig-warehouse-native/fabric/add_fabric_statsig_workload.png" alt="Fabric workload hub interface showing Add Workload button" />
</Frame>
...
<Frame>
  <img src="/images/statsig-warehouse-native/fabric/edit_fabric_statsig_warehouse_connection.png" alt="Statsig warehouse connection configuration interface" />
</Frame>
