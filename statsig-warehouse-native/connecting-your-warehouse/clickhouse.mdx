...
<Warning>
Statsig's Clickhouse connector is in Beta: some functionality may not be performance-optimized or may have minor syntax errors during the beta period.

Please reach out to support for assistance enabling Clickhouse for your Statsig WHN project.
</Warning>
