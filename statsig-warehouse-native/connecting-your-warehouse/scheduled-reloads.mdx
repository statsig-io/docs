...
last_update:
  date: 2025-09-18
description: You can control daily reload settings for Metrics and Experiments. While these can be configured on each entity, you can also set defaults that entiti
---
...
<Frame><img width="1443" alt="Project-level scheduled reload settings interface" src="/images/statsig-warehouse-native/connecting-your-warehouse/scheduled-reloads/d056be8d-19a0-43ae-91e1-cf5e16d23b53.png" /></Frame>

<Frame>
  <img src="/images/statsig-warehouse-native/connecting-your-warehouse/scheduled-reloads/efc232e7-4189-4ee7-b35a-5b1530041c70.png" alt="Individual experiment pulse scheduling interface" />
</Frame>
