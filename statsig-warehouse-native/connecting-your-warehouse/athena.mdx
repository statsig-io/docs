...
description: "Connect Amazon Athena to Statsig Warehouse Native, including IAM roles, S3 staging buckets, workgroups, query result locations, and required permissions."
sidebarTitle: Athena
keywords:
  - owner:vm
last_update:
