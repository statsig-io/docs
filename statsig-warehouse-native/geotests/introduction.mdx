...
last_update:
  date: 2025-09-18
description: Sometimes you just can't run an A/B test at a per-user level. Some common causes are: - You don't have per-user control over who sees what, e.g. a thi
---
