...
description: "Set up a geotest in Statsig Warehouse Native to measure the impact of a treatment across geographic regions when user-level randomization isn't possible."
...
<Frame>
  <img
    src="/images/geotests/geo_types_settings.png"
    alt="Geo types configuration interface"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/geo_column_mapping.png"
    alt="Geo column mapping configuration screen"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/CreateXP.png"
    alt="Experiment creation modal with analyze option"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/SetType.png"
    alt="Geotest experiment type selection dropdown"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/SetupXP.png"
    alt="Geotest experiment setup configuration screen"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/XPAdvancedConfigs.png"
    alt="Experiment configuration settings interface"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/StartDesigner.png"
    alt="Experiment designer launch button"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/CreateDesign.png"
    alt="Geographic limitations configuration interface"
  />
</Frame>
...
<Frame>
  <img src="/images/geotests/targeting.png" alt="Geotest targeting filters for eligible regions" />
</Frame>
...
<Frame>
  <img src="/images/geotests/targetingoverwrites.png" alt="Override interface assigning specific geos to treatment or control" />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/DesignerOptions.png"
    alt="Experiment designer options display"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/DesignOption.png"
    alt="Design option selection interface"
  />
</Frame>
...
<Frame>
  <img
    src="/images/geotests/AnalysisResults.png"
    alt="Geotest analysis results dashboard"
  />
</Frame>
