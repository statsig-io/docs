...
description: Control and manage Statsig release pipelines in progress using actions like approve, pause, skip, and abort to safely steer rollouts through stages.
---
...
<Frame>
  <img src="/images/release-pipeline/actions/519ecada-cce9-4b70-9492-62d21190a85a.png" alt="Release pipeline management actions" />
</Frame>
