...
description: Create, configure, and manage Statsig Release Pipelines for controlled, multi-stage feature rollouts with approvals, soak times, and rollback safeguards.
---
...
3. Feature Gates / Dynamic Configs Page
   ...
   - This will show all feature gates and dynamic configs with an ongoing release pipeline
    ...
    <Frame>
      <img src="/images/release-pipeline/create-and-manage/23a3199f-4710-40ed-9bd3-14d2ae5edb49.png" alt="Feature gates and dynamic configs with release pipeline status" />
    </Frame>
