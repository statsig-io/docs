...
description: "Get started with Statsig Contextual Bandits to personalize variant selection per user based on context features and a single goal metric."
...
<Frame>
  <img src="/images/autotune/contextual/getting-started/167d5e87-c155-4465-9419-bcf018c496cb.png" alt="Statsig console navigation with Autotune section highlighted" />
</Frame>
...
<Frame>
  <img src="/images/autotune/contextual/getting-started/b16fb9a6-80f4-495c-8ebc-b0cdcdb1d8a8.png" alt="Create contextual autotune dialog with name and goal fields" />
</Frame>

Set your autotune type to Contextual

<Frame>
  <img src="/images/autotune/contextual/getting-started/4398ae6f-0763-49c0-a49b-804daece4da8.png" alt="Autotune type selector set to Contextual" />
</Frame>
...
<Frame>
  <img src="/images/autotune/contextual/getting-started/4885eac2-38ec-42f1-bd52-592b728623a0.png" alt="Optimization settings screen choosing event outcome and metric source" />
</Frame>
...
<Frame>
  <img src="/images/autotune/contextual/getting-started/8c87e142-247d-42b3-8baa-04f8967ae400.png" alt="Training settings configuration showing exploration and attribution options" />
</Frame>
...
<Frame>
  <img src="/images/autotune/contextual/getting-started/591c0b49-2a40-4bb9-9bef-311bd1d64651.png" alt="Variants list showing configuration keys and values for contextual autotune" />
</Frame>
<Frame>
  <img src="/images/autotune/contextual/getting-started/10b13396-9bb5-4045-b514-45b0861885cb.png" alt="Variant detail editor specifying contextual parameters like button color" />
</Frame>
