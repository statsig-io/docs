...
description: "Use Statsig Contextual Bandits to personalize variant selection per user based on context features while maximizing a single goal metric over time."
