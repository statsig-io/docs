---
title: Bandit FAQs
description: "Frequently asked questions about Statsig Autotune multi-armed bandits, including methodology, traffic allocation, and how to interpret bandit results."
sidebarTitle: FAQ
keywords:
  - owner:craig
last_update:
