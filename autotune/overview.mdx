...
description: Statsig Autotune and Autotune AI use multi-armed bandits to weigh explore versus exploit and ship the best-performing variant for a single goal metric.
---
