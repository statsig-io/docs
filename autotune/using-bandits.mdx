---
title: Advanced Bandit Usage
description: "When and how to use Statsig multi-armed bandits to optimize for a single goal metric, including ideal use cases, limitations, and result interpretation."
