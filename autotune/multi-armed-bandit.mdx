---
title: Methodology
description: "How multi-armed bandits work in Statsig Autotune to automatically allocate traffic to the best-performing variant based on a single goal metric."
