...
<Frame>
  <img src="/images/feature-flags/overrides/148461864-4a5efd47-2e40-478f-81e5-49edfc5ea2e9.png" alt="Feature gate page with Add Override button highlighted" />
</Frame>

- Select either 'Pass List' or 'Fail List' from the tabs in the dialog

<Frame>
  <img src="/images/feature-flags/overrides/148462020-417c007f-d492-46f7-8d25-d7a5178b4fe2.png" alt="Manage overrides dialog showing pass and fail lists" />
</Frame>
...
<Frame>
  <img src="/images/feature-flags/overrides/148469394-9f86db83-26f6-4a5b-809f-8a53f0b4f1fa.png" alt="Edit overrides button within feature gate settings" />
</Frame>

- Hit the trashcan icon next to the user ID you wish to remove from a list.

  <Frame>
    <img src="/images/feature-flags/overrides/148463292-6740a09f-337f-441a-9cfa-a547a5dc6183.png" alt="Override list with trash icon to remove user ID" />
  </Frame>
...
<Frame>
  <img src="/images/feature-flags/overrides/148462648-e7da94bb-a681-4b0a-ad53-1254c6abe623.png" alt="Test gate console showing user object with override result" />
</Frame>

Users that pass will see "PASS (User ID Override)"

<Frame>
  <img src="/images/feature-flags/overrides/148462641-57b544c1-bbdb-48cf-bb7f-967b0b20fc63.png" alt="Test gate output indicating PASS due to user ID override" />
</Frame>

Users that fail will see "FAIL (User ID Override)"

<Frame>
  <img src="/images/feature-flags/overrides/148462634-de69b838-f7b1-431c-9119-64ce123ad218.png" alt="Test gate output indicating FAIL due to user ID override" />
</Frame>
