...
description: "Use Pre-Post Results in Statsig to analyze feature impact by comparing metrics before and after rollout when A/B testing isn't possible or practical."
---
