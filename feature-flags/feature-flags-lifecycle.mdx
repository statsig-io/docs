...
<Frame>
  <img src="/images/feature-flags/feature-flags-lifecycle/216169028-44ca6ce1-1300-44b6-9156-55ea52cd85ea.png" alt="Feature gate status options interface" />
</Frame>
...
<Frame>
  <img src="/images/feature-flags/feature-flags-lifecycle/216169769-23062719-92da-4ae5-a437-935b2ef5b05c.png" alt="Feature gate lifecycle workflow diagram" />
</Frame>
...
**1) The gate has been fully rolled out or rolled back, and you're ready to skip rule evaluation and assign default value (stop incurring costs for your gates)**
  ...
  - To find _all_ gates that are good candidates to be **Launched** or **Disabled** (i.e. have been rolled out to 100% or rolled back to 0% more than 30 days ago):
    ...
    - In the search bar: "Modified: `<YYYY/MM-DD;`" (update the date to be 30 days ago)
      ...
      <Frame>
        <img src="/images/feature-flags/feature-flags-lifecycle/216164917-85a7da7a-2ee6-4ba5-8ca6-c6ced99516ee.png" alt="Feature gates catalog filter interface" />
      </Frame>
...
Please confirm that these gates are not included in any active Holdouts before removing reference
  ...
  - To find *all* gates that are good candidates to be removed from your codebase (i.e. have been **Launched** or **Disabled** more than 60 days ago)
    - Go to Feature Gates catalog
      ...
      <Frame>
        <img src="/images/feature-flags/feature-flags-lifecycle/216166227-7e36df55-f540-4c74-a899-e0bfdfb808f6.png" alt="Feature gates catalog with launched and disabled filter" />
      </Frame>
...
- To find _all_ gates that should be marked as **Archived**:
    - Go to Feature Gates catalog
      ...
      <Frame>
        <img src="/images/feature-flags/feature-flags-lifecycle/216166665-b9ad6655-4c6e-4b66-8a65-8e94e98e3485.png" alt="Feature gates catalog with zero checks filter" />
      </Frame>
