...
description: "Configure pre-set, time-based feature rollout schedules in Statsig that automatically increase traffic percentages or flip rules at specific dates and times."
---
...
<Frame>
  <img src="/images/feature-flags/scheduled-rollouts/199850775-42528d6c-b8f1-4e5d-9774-bc1b576c2916.png" alt="Feature Gate rule menu options" />
</Frame>

Select **Edit Rule or Rollout**, and then select **Schedule Automated Rollout**.

<Frame>
  <img src="/images/feature-flags/scheduled-rollouts/199851487-2e2aba51-30d5-4fef-933f-b31c0e78dd57.png" alt="Schedule Automated Rollout selection" />
</Frame>
...
<Frame>
  <img src="/images/feature-flags/scheduled-rollouts/199851781-60606e6b-d653-408a-a3ba-399e32d582b0.png" alt="Scheduled rollout configuration interface" />
</Frame>
...
<Frame>
  <img src="/images/feature-flags/scheduled-rollouts/199851974-c95ea9d2-6d04-4c3e-b9e5-f5d5ea3d85b3.png" alt="Scheduled rollout phases preview" />
</Frame>

<Frame>
  <img src="/images/feature-flags/scheduled-rollouts/199851640-007d63d5-7b9e-4002-93af-132af24416a1.png" alt="Rollout phases hover preview" />
</Frame>
