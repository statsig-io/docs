...
description: View and manage automated safeguards on Statsig feature flags to detect regressions, halt risky rollouts, and protect critical metrics during deployment.
---
