...
description: Understand how Statsig evaluates feature gate rules from top to bottom and see the full list of supported targeting conditions and operators.
---
