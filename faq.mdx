...
Yes, you can rename experiments and gates after creating them. The display name can be changed at any time, but the ID (which is referenced in your code) remains immutable to prevent breaking existing implementations.
