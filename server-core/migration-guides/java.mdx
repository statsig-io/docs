...
The following configuration options have been renamed in Java Core SDK:

| Legacy Java SDK | Java Core SDK |
|----------------|---------------|
| `init_resources` | `spec_adapter_configs` |

If you were using `init_resources` in your configuration, you should now use `spec_adapter_configs` instead.
