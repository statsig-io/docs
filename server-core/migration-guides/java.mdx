...
description: Migrate from the legacy Java/Kotlin Server SDK to the new Statsig Java Core SDK with improved performance, including API changes and configuration updates.
---
