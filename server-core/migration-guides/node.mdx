...
description: Step-by-step guide to migrating from the legacy Statsig Node.js server SDK to the new Node Core SDK, covering API changes, options, and breaking changes.
---
