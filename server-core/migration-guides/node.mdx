...
description: Migrate from the legacy Node.js Server SDK to the new Statsig Node Core SDK, with API changes, imports, and configuration updates for backend services.
---
