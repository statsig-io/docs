...
description: Migrate from the legacy PHP Server SDK to the new Statsig PHP Core SDK, with API changes, imports, and configuration updates for PHP backend applications.
---
