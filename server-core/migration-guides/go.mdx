...
description: Migrate from the legacy Go Server SDK to the new Statsig Go Core SDK with improved performance, including API changes, imports, and configuration updates.
---
