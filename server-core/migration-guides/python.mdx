...
description: Migrate from the legacy Python Server SDK to the new Statsig Python Core SDK, with API changes, imports, and configuration updates for Python services.
---
