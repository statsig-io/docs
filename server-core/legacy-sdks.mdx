...
description: "Reference for Statsig's long-lived legacy Server SDKs that are transitioning to the Server Core framework, including supported versions and migration timelines."
---
