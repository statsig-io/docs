...
sidebarTitle: Node
description: Statsig's next-generation Node.js Server SDK built on the Server Core framework, with improved performance and a unified evaluation engine for Node backends.
icon: "node-js"
---
