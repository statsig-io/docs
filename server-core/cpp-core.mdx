...
title: C++ Server SDK
sidebarTitle: C++
description: Statsig's next-generation C++ Server SDK built on the Server Core framework, with improved performance and a unified evaluation engine for backend services.
icon: "C++"
---
