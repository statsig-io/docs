...
description: Statsig Server Core is the second generation of Server SDKs with improved performance, a unified evaluation engine, and consistent APIs across languages.
---
