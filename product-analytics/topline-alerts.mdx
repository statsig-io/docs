...
description: 'Configure Statsig topline alerts to get notified in Slack or email when key product metrics shift beyond a fixed threshold or relative change in value.'
---
