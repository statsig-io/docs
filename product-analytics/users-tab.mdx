...
description: 'The Statsig Users tab gives an event-by-event level understanding of how individual users interact with your product, useful for debugging and support.'
---
...
<Frame>
  <img width="1374" alt="Event log stream interface" src="/images/product-analytics/users-tab/1ff4af6a-c467-4dc1-8b9e-fb58818cb67b.png" />
</Frame>
...
<Frame>
  <img alt="Session stream interface showing user events grouped by session" src="/images/product-analytics/users-tab/7ac4a9f8-a3d4-485b-9a8a-8ce972ba6cda.png" />
</Frame>
