---
title: 'Lifecycle'
description: 'Use Statsig lifecycle analysis to understand how users start, return, remain, and churn over time so you can target the right cohorts for growth experiments.'
---
