...
description: Statsig Python SDK for AI evaluations: configure prompts, models, and parameters and log AI application telemetry for offline and online evaluations.
---
...
import ProgrammaticEval from '/snippets/ai-sdks/python/programmatic-eval.mdx'
...
<Info>
The Statsig AI Python SDK is currently in beta. We are no longer accepting new beta customers at this time.
</Info>
