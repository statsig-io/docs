...
description: Statsig Node SDK for AI evaluations: configure prompts, models, and parameters and log AI application telemetry for offline and online evaluations.
---
...
import InitializationWOptions from '/snippets/ai-sdks/node/initializationWOptions.mdx'
import InitializationManagedWOptions from '/snippets/ai-sdks/node/initializationManagedWOptions.mdx'
...
<Info>
The Statsig AI Node SDK is currently in beta. We are no longer accepting new beta customers at this time.
</Info>
