...
description: "Manage AI prompts and graders in Statsig to evaluate, version, and roll out prompts in production without deploying code, similar to dynamic configs."
...
<img alt="Prompt creation screen showing model selection and message list" src="/images/ai-evals/prompts/77256d12-0d3f-4caa-8fa7-3719517af4eb.png" />
</Frame>

<Frame caption = "Code snippet to retrieve the Live version of the prompt">
<img alt="Code example calling statsigAI.getPrompt to fetch live prompt version" src="/images/ai-evals/prompts/66e3b7f6-4613-4d7c-84c7-0fd84f890a29.png" />
</Frame>

<Frame caption = "Looking at the scores for a prompt version">
<img alt="Prompt results page summarizing grader scores per version" src="/images/ai-evals/prompts/546c4974-b01d-4d13-85a1-4f2a6bfbb6c1.png" />
</Frame>
