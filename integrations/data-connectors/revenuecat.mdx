---
title: RevenueCat
description: "Connect RevenueCat with Statsig to send mobile subscription events to Statsig for revenue experiment analysis and lifecycle metric tracking."
---
...
3. Enter your **Statsig Server Secret** and click **Save**.
   ...
   <Frame>
     <img src="/images/integrations/data-connectors/revenuecat/f8b5f66-Screen_Shot_2021-11-05_at_9.20.40_AM.png" alt="RevenueCat integration settings entering Statsig secret" />
   </Frame>
