---
title: Census
description: "Connect Census reverse ETL with Statsig to sync audience segments and metric data between your data warehouse and Statsig for activation."
---
...
<Frame>
  <img src="/images/integrations/data-connectors/census/b3134399-288d-4a0f-b4d2-4b88980f0718.png" alt="Census destination setup form with Statsig secret key input" />
</Frame>
...
<Frame>
  <img src="/images/integrations/data-connectors/census/e5d1154d-bd55-48d8-a300-13d96a89a0c8.png" alt="Census sync configuration showing sync key selection" />
</Frame>
...
<Frame>
  <img src="/images/integrations/data-connectors/census/7fce9183-312c-4b47-90c4-b48b0479ecca.png" alt="Field mapping table aligning Census columns to Statsig event fields" />
</Frame>
...
<Frame>
  <img src="/images/integrations/data-connectors/census/213269548-e6457527-c938-44fd-9360-1f3fd7af2fac.png" alt="Statsig integration panel for Census custom ID mapping" />
</Frame>
