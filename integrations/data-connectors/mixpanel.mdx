...
<Frame>
  <img src="/images/integrations/data-connectors/mixpanel/195177166-07b0f568-836c-4ae8-ba93-e4f1da64bd39.png" alt="statsig-segment-config" />
</Frame>
...
2. Paste your project token into the Outgoing configuration on the Statsig integration panel and hit "Enable" (or "Confirm" if you are updating the integration).
   ...
   <Frame>
     <img src="/images/integrations/data-connectors/mixpanel/195172632-e14fe03f-377f-435f-92ca-60fe20da4746.png" alt="mixpanel-outgoing-configuration" />
   </Frame>
