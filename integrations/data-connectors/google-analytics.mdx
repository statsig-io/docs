...
2. Statsig requires an API secret to send the data to your stream, navigate to your stream and create a new secret:
    <Frame>
      <img src="/images/integrations/data-connectors/google-analytics/263364181-a672aec0-15c1-4030-a4c8-2e2a58083d7e.png" alt="" />
    </Frame>
    <Frame>
      <img src="/images/integrations/data-connectors/google-analytics/263364616-65a054d6-c0b7-48ba-84ee-cbdb7f5eaa9a.png" alt="" />
    </Frame>
    <Frame>
      <img src="/images/integrations/data-connectors/google-analytics/263364730-b419ac78-01cb-453c-8cd3-c0b5f7a3cb6a.png" alt="" />
    </Frame>
    <Frame>
      <img src="/images/integrations/data-connectors/google-analytics/263364942-1fb5da05-dbfc-4362-86f8-8d77bdd23cd4.png" alt="" />
    </Frame>
...
3. Once created, copy the API secret and the measurement ID (optional). Navigate to your Statsig Project -> Project Settings -> Integrations -> Google Analytics (click enable) -> Google Analytics 4.
    ...
    <Frame>
      <img src="/images/integrations/data-connectors/google-analytics/263366565-c9f97636-8bd3-428f-b2ee-e542776b50ab.png" alt="" />
    </Frame>
...
<Frame>
  <img src="/images/integrations/data-connectors/google-analytics/264458718-69f0d248-7df3-4360-bdb4-dcffb1503e3c.png" alt="" />
</Frame>
