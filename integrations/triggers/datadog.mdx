...
description: "Configure Datadog triggers in Statsig to react to Datadog monitor events with automated rollback, killswitch, or notification actions on feature flags."
---
...
3. Specify the target gate and action, then click **Create**
   <Frame>
     <img src="/images/integrations/triggers/datadog/216156433-a41461d7-349b-446a-a089-610e57917824.png" alt="Statsig trigger configuration interface" />
   </Frame>
...
2. In Datadog, create a new [Webhook](https://app.datadoghq.com/integrations/webhooks) using that URL. (You do not need to make any changes to the payload)
   <Frame>
     <img src="/images/integrations/triggers/datadog/216156415-2b170a22-71ea-48af-9db9-dc3f76a357a4.png" alt="Datadog webhook configuration screen" />
   </Frame>
3. Now within your Datadog monitor settings, you can add this webhook as a notification target.
   <Frame>
     <img src="/images/integrations/triggers/datadog/216156425-8dd57f92-aa64-4a55-8bd4-4737a8e6818e.png" alt="Datadog monitor notification settings" />
   </Frame>
