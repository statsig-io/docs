---
title: Datadog
description: Triggers can be used with Datadog to toggle a gate on or off depending on the performance of a metric. 1. On Statsig console, navigate to the [integra
---
