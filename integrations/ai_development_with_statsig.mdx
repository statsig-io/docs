...
description: Use the Statsig MCP server with AI coding agents like Claude Code, Cursor, and Codex to add killswitches and log critical events for AI-written code.
---
