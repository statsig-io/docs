...
last_update:
  date: 2025-09-18
description: Embeddings are numerical representations of data (like text, images, or audio) that capture their essential features in a compact form, typically as v
---
...
This page explains generate text embeddings.
