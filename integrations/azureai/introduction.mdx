---
title: Azure AI
description: "Introduction to the Statsig Azure OpenAI integration for logging AI calls, capturing metrics, and running experiments on prompts and model parameters."
