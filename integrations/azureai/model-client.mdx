...
description: "Use the Statsig Azure OpenAI model client to wrap chat, completion, and embedding calls with automatic logging and experiment-aware routing."
keywords:
  - owner:vijaye
last_update:
  date: 2025-09-18
...
<Frame>
  <img src="/images/integrations/azureai/model-client/29357d6f-c356-461c-afc7-e1673ba97f92.png" alt="Dynamic Config creation interface" />
</Frame>

Once created, you can fill in the properties of this deployment like this:

<Frame>
  <img src="/images/integrations/azureai/model-client/e4d20573-9d1f-4d62-af11-408435d02f90.png" alt="Dynamic Config properties configuration screen" />
</Frame>
