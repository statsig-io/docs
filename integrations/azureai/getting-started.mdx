...
description: "Get started with the Statsig Azure OpenAI integration to log AI requests, capture metrics, and run experiments on prompts, models, and parameters."
keywords:
  - owner:vijaye
last_update:
  date: 2025-09-18
