...
last_update:
  date: 2025-09-18
description: Chat completions are AI-generated responses used to generate text. They could enable generic text completion, or interactive dialogue based on a given
---
...
This page explains simple completions.
