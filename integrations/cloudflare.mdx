---
title: Cloudflare KV
description: "Run Statsig feature gate and experiment evaluations at the edge with Cloudflare Workers for low-latency rules evaluation in your CDN layer."
---
...
<Frame>
  <img src="../images/client/Events.png" alt="Statsig Events log stream showing gate_check events with timestamps and user IDs" />
</Frame>
