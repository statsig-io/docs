...
last_update:
  date: 2025-09-18
description: You can create a .tf file (Terraform File) to configure your Statsig feature gates. All features of [console/v1/gates](/console-api/gates) are support
---
