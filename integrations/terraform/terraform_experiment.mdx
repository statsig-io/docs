...
last_update:
  date: 2025-09-18
description: You can create a .tf file (Terraform File) to configure your Statsig experiments. All features of [console/v1/experiments](/console-api/experiments) a
---
...
This page explains basic example.
