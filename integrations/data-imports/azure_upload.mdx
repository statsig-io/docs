...
| user           | A JSON object representing the user this event was logged for; refer to the following example                                          | Escaped JSON string including the keys 'custom' and 'customIDs'. A userID or customID must be provided. |
...
| denominator  | Denominator for metric calculation                                                                                            | Double format. refer to the relevant section                                                                                                                                                                                                                     |
