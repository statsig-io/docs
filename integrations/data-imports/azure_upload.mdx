...
description: "Import event and metric data into Statsig from Azure Blob Storage on a schedule, including file format options and column-to-event mappings."
slug: azure-upload
keywords:
  - owner:tim
last_update:
