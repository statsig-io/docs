...
description: "Import event and metric data into Statsig from Google BigQuery on a schedule, including authentication, queries, and column-to-event mappings."
slug: bigquery
keywords:
  - owner:tim
last_update:
