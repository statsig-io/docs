...
description: "Overview of data import options for Statsig, including ingestion from data warehouses, object storage, and customer data platforms via connectors."
---
<Note>
