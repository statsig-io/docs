---
title: Datadog
description: There are four key use-cases to the Datadog integration: 1. [Config Changes](#config-changes) - Streaming changes made in Statsig into Datadog, so you
---
...
<Frame>
  <img src="/images/integrations/datadog/232632837-d1e81380-78a3-48a2-887d-72b13d541b0a.png" alt="Datadog API key creation interface" />
</Frame>
...
<Frame>
  <img src="/images/integrations/datadog/232636042-ee5cf1d0-e9e7-4158-903b-5a447ab14575.png" alt="Datadog Events Explorer interface" />
</Frame>
...
<Frame>
  <img src="/images/integrations/datadog/232629870-e1776bd6-c63d-438d-863e-2d7a3a347eab.png" alt="Datadog check_gate metric visualization" />
</Frame>
