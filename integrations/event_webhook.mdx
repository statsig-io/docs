---
title: Event Webhook
description: "Configure event webhooks in Statsig to forward exposure, gate, and experiment events to your own HTTP endpoints in near real time."
keywords:
  - owner:brock
last_update:
  date: 2025-09-18
...
>
  <img src="/images/integrations/event_webhook/162286552-c257a736-4050-4d0a-8223-67097c731c0b.png" alt="Statsig Webhook integration card with Enable button" />
</div>
...
<img width="738" alt="Webhook integration card showing signing secret" src="/images/integrations/event_webhook/209035738-bbbc0944-b428-4454-bf19-8845892c2044.png"></img>
