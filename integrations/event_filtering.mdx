...
description: "Configure event filtering in Statsig to control which events are ingested, dropped, or transformed before they reach metrics and experiments."
---
