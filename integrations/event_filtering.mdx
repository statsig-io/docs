...
description: Once you've enabled an integration, you can select specific events that you want to send and/or receive by clicking on the **Event Filtering** button.
---
...
<Frame>
  <img src="/images/integrations/event_filtering/150829446-149dc7c5-0025-451a-8fae-09760b4f0566.png" alt="Event filtering dialog interface" />
</Frame>

- You can now search for specific events and select or deselect the events that you want Statsig to ingest.

<Frame>
  <img src="/images/integrations/event_filtering/150829346-e2f29d7e-bca3-4427-8d54-02e96f37951d.png" alt="Event selection interface for incoming events" />
</Frame>
...
<Frame>
  <img src="/images/integrations/event_filtering/150853774-6112c939-d101-4e15-9f74-3d872e6ba6f3.png" alt="Outgoing event filtering configuration" />
</Frame>
