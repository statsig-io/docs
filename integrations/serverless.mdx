...
The serverless SDK is a lightweight JS based SDK optimized for serverless environments while being compatible for any other use case. This SDK harnesses the functionalities that all Statsig server SDK's offer.
