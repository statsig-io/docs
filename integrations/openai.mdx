---
title: OpenAI 
description: "Integrate Statsig with OpenAI to log AI requests, capture metrics, and run experiments on prompts, models, and parameters across your applications."
---
## Context
