...
<Frame>
  <img src="/images/ai-remove-from-code.png" alt="An example of Remove from Code in a stale gate banner" />
</Frame>

* Understand the intent behind metrics and experiments based on code implementation

<Frame>
  <img src="/images/ai-contextual-description.png" alt="An example of AI description in the right rail of a config" />
</Frame>
