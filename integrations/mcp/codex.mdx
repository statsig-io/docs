...
description: Configure the Statsig MCP server in Codex CLI, the Codex IDE extension, and the Desktop App so you can query Statsig data and manage features from Codex.
---
