...
description: Manually configure the Statsig MCP server for any MCP-compatible tool, including authentication, scopes, transport options, and recommended client settings.
---
