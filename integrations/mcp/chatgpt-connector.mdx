...
description: Set up the Statsig ChatGPT connector to query experiments, feature gates, and metric data directly from OpenAI ChatGPT using natural language prompts.
---
