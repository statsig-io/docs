...
You can set up a ChatGPT App (built on top of the Statsig MCP server), allowing you to query experiments, manage feature flags, explore analytics -- all directly within ChatGPT's conversational interface.
