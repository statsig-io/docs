---
title: Overview
description: Connect the Statsig MCP server to Codex, Cursor, and Claude Code so AI assistants can explore experiments, feature gates, and metrics in your project.
---
