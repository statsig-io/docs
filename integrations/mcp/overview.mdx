...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Create a new segment. Supports <code>id_list</code>, <code>rule_based</code>, <code>analysis_list</code>, and <code>user_store_id_list</code> segment types
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td style={{ width: "280px", overflowWrap: "anywhere", wordBreak: "break-word" }}>Get_Segment_by_ID</td>
      <td>
        Get all details about a segment in the Statsig Console. Requires:
        <ul>
          <li><code>id</code></li>
        </ul>
      </td>
