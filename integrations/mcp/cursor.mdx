...
description: Set up the Statsig MCP server in Cursor IDE so the agent can read experiments, feature gates, and metric data while writing and reviewing code.
---
