...
description: Set up the Statsig MCP server in Claude Code so the agent can query experiments, feature gates, metrics, and project data directly from your terminal.
---
