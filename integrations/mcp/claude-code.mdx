...
On Claude Code, we recommend using the HTTP transport directly. Run this command on the command line:
...
While we recommend setting up Statsig MCP via OAuth, you can also authenticate with your Console API key. 
