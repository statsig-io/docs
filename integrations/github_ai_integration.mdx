...
* Write natural language queries to create charts to answer business questions
...
If your organization uses [IP restrictions](https://docs.github.com/en/apps/maintaining-github-apps/managing-allowed-ip-addresses-for-a-github-app) to limit access to your GitHub resources, you must allowlist the IP addresses that Statsig services use to connect to GitHub.

Please add the following Statsig IP addresses to your GitHub allowlist:
