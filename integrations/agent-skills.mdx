...
description: Use the public Statsig agent-skills repository to extend Cursor, Claude Code, and other coding agents with reusable Statsig workflows and capabilities.
---
