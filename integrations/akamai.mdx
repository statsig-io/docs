...
description: "Run Statsig feature gate and experiment evaluations at the edge with Akamai EdgeWorkers for low-latency rules evaluation in your CDN layer."
---
