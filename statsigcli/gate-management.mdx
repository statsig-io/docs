...
description: "Use the Statsig CLI to manage feature gates programmatically, including listing, creating, editing, and archiving gates from your terminal or CI."
