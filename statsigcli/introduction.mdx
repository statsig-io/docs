...
description: The Statsig CLI (Siggy) is a command-line tool for creating, managing, and automating feature gates, experiments, and dynamic configs from scripts and CI/CD.
---
