...
keywords:
  - owner:vm
last_update: 2025-01-27 16:36:15 -0800
---
...
Statsig detects this bias by running the standard [pulse](../pulse) calculation on the pre-experiment term (looking back one week in cloud, and your configured CUPED lookback window in Warehouse Native), and calculating the p-value for the null hypothesis that the groups are identical.
