...
Statsig would detect this bias by running the standard [pulse](../pulse) calculation on this pre-experiment term, and calculating the p-value for the null hypothesis that the groups are identical.
