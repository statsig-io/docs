...
The z-statistic (a.k.a. z-score) of a two-sample, two-sided z-test can be computed in multiple equivalent formats:
...
- $\sigma_{\overline{X}_t}$ is the standard error of the mean of either control or treatment group
