...
$
CI(\Delta \overline X\%) = \Delta \overline X\% \pm Z \cdot\sqrt{{var(\Delta \overline X\%)}} = \Delta \overline X\% \pm Z \cdot\sqrt{{var\left(\frac{\Delta \overline X}{\overline X_c}\right)}}  
$
