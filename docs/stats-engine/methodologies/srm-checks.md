...
We automatically analyze data by common dimensions logged by the Statsig SDK to identify potential drivers of SRM and you can break down your SRM P-Values by these dimensions in Metrics Explorer. These include sdk_type, sdk_version, reason, is_bot, browser_name, browser_version, os, os_version and region to identify potential causes.
