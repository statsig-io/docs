:::info
Statsig's normal (remote evaluation) SDKs are generally recommended for most applications. Understand the use case and privacy risks by reading the [On-Device Eval SDK overview](client/onDevice). On-device evaluation SDKs are for Enterprise & Pro Tier only.
:::
