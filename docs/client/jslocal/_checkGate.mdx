...
To check a gate with exposure logging disabled, you can set that field in the options.  Exposure logging will be disabled for that check only - you must pass that parameter with every check you wish to disable exposure logging for.
```
