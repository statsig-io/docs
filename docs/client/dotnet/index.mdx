...
These docs are for using our .NET SDK in a single-user, client side context. For server side and multi-user contexts, check out our [.NET SDK for server](/server/dotnetSDK).
:::
