...
The `statsig-react-native` SDK relies on the `statsig-js` SDK and inherits its browser compatibility. For more information, see the [statsig-js docs](https://docs.statsig.com/client/deprecated/jsClientSDK#what-kind-of-browser-support-can-i-expect-from-the-sdk).
