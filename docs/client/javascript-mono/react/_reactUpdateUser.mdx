...
If your user information (identity, properties) become available on the webpage asyncronously after Statsig has loaded, you should consider defering initialization rather than initializing with an empty user object and calling updateUser later on.
