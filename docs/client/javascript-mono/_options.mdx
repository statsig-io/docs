...
> - `LoggingEnabledOption.browserOnly` - Only logs events in browser environments (default behavior)
> - `LoggingEnabledOption.disabled` - Prevents collecting and sending any events over the network
> - `LoggingEnabledOption.always` - Enables logging in all environments (browser and non-browser like VSCode extensions, Chrome extensions, CLIs, etc.)
>
