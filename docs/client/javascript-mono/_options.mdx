...
> - `LoggingEnabledOption.browserOnly` (`"browser-only"`) - This is the default behavior. Log events in browser environments, skipping it when running on a server. Useful for server-side rendering.
