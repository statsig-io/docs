...
We offer deeper integrations with Next.js that improve the performance and stability of your Statsig integration.  We recommend using Client Bootstrapping at a minimum, but if you were just trying to log an event or check your first gate, your project is configured with the above basic setup instructions.
