...
---
:::info
Only available for Statsig Client SDKs
:::

Parameter Stores are a new way of organizing and managing parameters in your web or mobile app via the Statsig console.  They are now available for Statsig JS, React, React Native, Android, iOS, and Dart sdks.
