...
* If you're using Statsig's new JS SDK, ensure that set the hashing algorithm as DJB2 when calling getClientInitializeResponse(), as the new JS SDK uses DJB2 by default.
