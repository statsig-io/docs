...
- `initializingComponent?: React.ReactNode | React.ReactNode[];` - A loading component to render if waitForInitialization is set to true and the SDK is initializing
