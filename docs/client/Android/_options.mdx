...
- **loggingEnabled**: `Boolean`, default `true`
 ...
 - This can be useful for cases where it is neccesary to users to grant permission before events should be logged, or in any other cases where logging should not be enabled
