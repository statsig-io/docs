...
At the time of this writing, only `Node.js`, `Ruby`, `Go`, and `.NET` support polling for updates. If you're interested in using a DataAdapter as the source of truth indefinitely, please reach out and let us know which language this would be useful for!
:::
