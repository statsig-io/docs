...
If you're interested in using a DataAdapter as the source of truth indefinitely, please reach out to the [support team](mailto:support@statsig.com) or in our [Slack community](https://statsig.com/slack) and let us know which language this would be useful for!
:::
