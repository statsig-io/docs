...
- Cloudflare [Workers Paid](https://developers.cloudflare.com/logs/logpush/) or Enterprise Plan
...
- Make sure token has logs edit permissions at the account level
- [Locate cloudflare account ID](https://developers.cloudflare.com/fundamentals/account/find-account-and-zone-ids/)
