...
slug: /server/concepts/user_persistent_storage
---

If you want to ensure that a user's variant stays consistent while an experiment is running, regardless of changes to allocation or targeting, you can use a User Persistent Storage.
