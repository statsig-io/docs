...
| IP                | IP address of the user. Will be inferred if not provided                                                                                                                                                                                                                 | `192.168.1.101`                                                                                                            |
| Country           | 2 letter coutry code of the user. Will be inferred if not provided.                                                                                                                                                                                                      | `US`                                                                                                                       |
| Locale            | Locale of the user. When using the Android or iOS SDK, Locale will be inferred if not provided.                                                                                                                                                                          | `en_US`                                                                                                                    |
| App Version       | Version of the app the user is using. When using the Android or iOS SDK, App Version will be inferred if not provided.                                                                                                                                                   | `1.0.1`                                                                                                                    |
...
| Private Attibutes | Dictionary that can contain key/value pairs that can be used for Feature Gate targeting. The content of this dictionary will **not** be stored after used for targeting and will be removed from any log_event calls.                                                    | `{sensitive_field: "sensitive_information", ...}`                                                                          |
