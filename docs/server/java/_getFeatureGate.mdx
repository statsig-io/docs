...
# `APIFeatureGate` Data Class Overview

The `APIFeatureGate` data class encapsulates the evaluation result of a feature gate for a specific user. It provides detailed information regarding whether the feature gate is enabled or disabled etc.
...
Below is an example of how you might access the properties of an `APIFeatureGate` object:
