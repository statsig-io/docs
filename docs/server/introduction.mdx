...
Check out the [UserID Requirements](/messages/serverRequiredUserID) to understand why having a unique `userID` in the [**StatsigUser**](/concepts/user) object is critical for server SDK usage.
