:::note
This SDK is in Beta, and some instructions here may change over time. This guide follows setup in the [slim framework](https://www.slimframework.com/), you may need to adjust given your setup. See a full, working example [here](https://github.com/daniel-statsig/statsig-php-core-slim-example). If you need help, reach out in the Statsig [Slack](https://statsig.com/slack)
:::
