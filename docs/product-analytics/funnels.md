...
keywords:
  - owner:akin
last_update: 2025-03-10 21:33:36 -0700
---
# Funnels
...
### Example Use Cases[](/product-analytics/funnels#example-use-cases)
...
### Step 1: Add Steps to your Funnel[](/product-analytics/funnels#step-1-add-steps-to-your-funnel)
...
### Step 2: Select a Graph Type[](/product-analytics/funnels#step-2-select-a-graph-type)
...
### Step 3: Choose an ID Type[](/product-analytics/funnels#step-3-choose-an-id-type)
...
### Step 5: Drilldown[](/product-analytics/funnels#step-5-drilldown)
...
## Advanced Funnel Analysis[](/product-analytics/funnels#advanced-funnel-analysis)

### Ordered or Unordered Funnels[](/product-analytics/funnels#ordered-or-unordered-funnels)
...
### Unique Users (or Unit ID) vs Total Conversions[](/product-analytics/funnels#unique-users-or-unit-id-vs-total-conversions)
...
### Daily Aggregation[](/product-analytics/funnels#daily-aggregation)
