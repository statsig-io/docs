...
Group-By limits can be added by first adding a group-by, and then clicking the "...", and selecting "Add Group-By Limit". You can use this to further drill down on your top X categories (up to 50). This feature is available for line charts, stacked-line charts, bar charts, and stacked-bar charts.
