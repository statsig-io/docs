...
You can add thousands of identifiers using this page in the Statsig console. There is a hard cap of 10 million IDs across all ID list segments in a project.
