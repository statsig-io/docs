...
You can add thousands of identifiers using this page in the Statsig console. There is a hard cap of 10m IDs across all ID list segments in a project. Using very large ID lists will cause server SDKs to take longer to initialize. 
