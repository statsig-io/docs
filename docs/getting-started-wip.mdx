...
export const OutlinedCard = ({title, description, icon}) => (
    <Card
        style={{
            width: '240px',
            margin: '8px',
...
<div style={{
    ...
    <OutlinedCard
        title="Feature Gates"
        icon="tune"
        description="Feature Gates are Statsig's take on Feature flags">
    </OutlinedCard>
    <OutlinedCard
        title="Dynamic Configs"
        icon="dns"
        description="Dynamic Configs store complex configurations and allow realtime updating and targeting to update otherwise hardcoded constants">
    </OutlinedCard>
    <OutlinedCard
        title="Segments"
        icon="donut_small"
        description="Define a set of users to target and reuse that segment in Feature Gate, Dyanmic Config, and Experiment targeting">
    </OutlinedCard>
    <OutlinedCard
        title="Feature Gates"
        icon="tune"
