...
##What about Gates, Experiments and Aanalytics?
The standard suite of Statsig product building capabilities are also available for use here. You can for example, target an  LLM feature at a set of people that meet some criteria with a Feature Gate, or choose to roll out a new prompt version as an Experiment and understand impact on metrics, similar to any other experiment.
