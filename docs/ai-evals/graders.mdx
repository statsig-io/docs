...
Process: It applies a scoring method. This could be: Rule-based (exact string match, regex check, BLEU/GLEU score, cosine similarity) or LLM-as-a-Judge (using another model to evaluate correctness, relevance, style, or safety).
