...
The rules that you create are evaluated in the order you create them. For each rule, the **criteria** or **conditions** determine which users _qualify_ for the Pass/Fail treatments. The Pass filter percentage further determines the percentage of _qualifying_ users that will be exposed to the new feature. 
