...
- You must either forward the unit ID to the SDK ([docs](https://docs.statsig.com/client/introduction)) or utilize the SDK to manage your features and correspondingly generate the metrics table.
