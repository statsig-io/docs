...
### When your unit of assignment is different from your unit of analysis
[What to do when your unit of assignment is different from your unit of analysis](https://docs.statsig.com/metrics/different-id)
