...
Otherwise, you can quickly follow our guide to setting up an [A/A test](/guides/aatest), using the same data you used for your exposures. This should generate a neutral experiment result.
