...
Otherwise, you can quickly follow our guide to setting up an [A/A test](/statsig-warehouse-native/guides/aa-test), using the same data you used for your exposures. This should generate a neutral experiment result.
