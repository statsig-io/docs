...
- An end-to-end experimentation platform covering targeting, experiment setup and assignment, and analysis
  - Includes Feature Flagging, Automated/Protected Rollouts, Native Holdouts, Mutual Exclusion, and the analysis tools below
...
Using [Statsig SDKs](/sdks/getting-started) with Statsig Warehouse Native is identical to integrating with Statsig Cloud. Statsig's SDKs cover dozens of languages, and are used by thousands of customers. The basic steps are to:
...
Statsig's [data analyses](/pulse/read-pulse) run in your data warehouse. All of the queries, intermediate datasets, and results that Statsig runs will be available in your warehouse for auditing and any custom analysis.
