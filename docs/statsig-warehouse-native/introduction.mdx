...
slug: /statsig-warehouse-native/glossary
...
Statsig Warehouse Native brings Statsig's to your warehouse. Assess the impact of new features on-demand, on your compute, and mix and match use Statsig's SDKs with your own sources of metric and assigment data.
...
With Statsig Warehouse Native, you set up connections to your source data using basic SQL queries and define Metrics as measures on top of that source data. Statsig will run a SQL-based [data pipeline](analysis_tools/pipeline-overview.md) in your warehouse to run experimental analysis on your raw data. At the end, Statsig downloads a small result set with no user identifiers - just group-level summary data.
...
>
  ...
  <OutlinedCard
    ...
    link="statig-warehouse-native/guides/sdks"
  ></OutlinedCard>
</div>
...
>
  ...
  <OutlinedCard
    ...
    link="statsig-warehouse-native/analysis/pulse"
  ></OutlinedCard>
  <OutlinedCard
    title="Insights"
    icon="donut_small"
