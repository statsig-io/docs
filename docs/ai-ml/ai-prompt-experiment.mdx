...
<div align="center">
    ...
    <source src="/img/ai/tutorial.webm" type="video/webm" />
...
1. Log in to your Statsig Console
2. Navigate to the **Experiments** section from the left-side navigation menu
3. Click on the **+Create** CTA
4. Name your prompt experiment, add an (optional) description, and under **Advanced** drop-down -> **Experiment Type** --> select "Experiment Type: Prompt Experiment"
