...
<head>
    <title>Statsig | Docs</title>
    <meta property="og:title" content="Statsig Docs" />
    <meta property="og:description" content="Statsig is a modern application building framework that automates A/B tests so you can get to the right product decisions, ultra-fast!" />
    <meta property="og:url" content="https://docs.statsig.com/" />
    <meta property="og:image" content="https://www.statsig.com/images/statsig_logo_blue.png" />
