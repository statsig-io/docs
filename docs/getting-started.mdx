...
#### How can I get started running an A/B Test?

You can run simple A/B tests by opening up a partial rollout on any feature gate. You then analyze the results of the experiment in the "Pulse" tab of the gate.  This is available to all projects, from the Free tier up through Enterprise contracts.  To get started, follow the [your first feature guide](/guides/first-feature).  When your feature is ready, just be sure to include a partial rollout rather than a 100% release.  This will create test/control groups to compare your metrics.

If you're looking for multivariate experiments (A/B/...N tests) and mutual exclusivity, check out our flagship [Experiments](/experiments-plus/) product. You can also [follow this guide to set up and run your first A/B test on Statsig](/guides/abn-tests).  Note that the "Experiments" feature is only available to the Pro tier and above.
