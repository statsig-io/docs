...
<div className="welcome-card-container padding--lg" style={{ display: 'flex', flexWrap: 'wrap' }}>
  <Column className="padding--sm">
    <Card className="welcome-card" shadow="tl">
      <CardHeader>
        ...
        Learn how to use the Statsig SDK and get started in minutes.
      </CardHeader>
      <CardFooter>
  ...
  <Column className="padding--sm">
    <Card className="welcome-card" shadow="tl">
      ...
      <CardFooter>
        <button className="button button--secondary button--block" link="/statsig-warehouse-native/introduction">Read guides</button>
      </CardFooter>
    </Card>
  </Column>
  ...
  <Column className="padding--sm">
    <Card className="welcome-card" shadow="tl">
      <CardHeader>
        ...
        Find full guides, walkthroughs, and more for your scenarios.
      </CardHeader>
      <CardFooter>
        <button className="button button--secondary button--block" link="guides/first-device-level-experiment">View tutorials</button>
      </CardFooter>
    </Card>
  </Column>
