...
We offer two different forms of SDK, client and server. Each has tradeoffs and is solving for different problems. Learn about the differences [here](/sdk/client-vs-server).
