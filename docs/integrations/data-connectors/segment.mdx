...
If you want to use your Segment Anonymous ID in lieu of the Statsig StableID (or another CustomID) you can map it using the integration. Remember to also do this with the Statsig SDK so IDs from exposure events can be matched with the Segment events.
