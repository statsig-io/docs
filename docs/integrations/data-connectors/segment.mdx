...
Refer to the follow diagram to help orient you to a working example of mapping anonymousIds in Segment to a custom ID in Statsig:
...
If you're using custom fields to [target users](/feature-gates/conditions#custom) in your feature gates, you can provide these properties through Segment using the key `statsigCustom` as part of the Segment `properties` 
