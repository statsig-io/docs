...
Once enabled, Statsig will forward exposures and logged events to a configured Data Stream. This data can optionally be filtered with [event filtering.](/integrations/data-connectors/google-analytics#configure-event-filtering)
...
## Confiuring outbound events to Google Analytics 4
...
1. Navigate to the GA4 admin settings. Under your app's property click Data Streams and select the stream youj'd like to use. If you don't have a stream you'll need to create one.
