...
Unlock the potential of first exposures, an enterprise-tier feature that enriches your project insights. To enable this functionality for your project, manual activation is required.

### What is it?

Our Amplitude Integration offers the flexibility to forward first exposures instead of every exposure, reducing the overall number of events being forwarded. We calculate first exposures on a daily basis and initiate forwarding the results every day at 7pm UTC.
