...
First exposures are an enterprise-tier feature that simplifies your project insights. To enable this functionality for your project, manual activation is required.
...
Our Amplitude Integration offers the flexibility to forward first exposures instead of every exposure, reducing the overall number of events being forwarded. 
