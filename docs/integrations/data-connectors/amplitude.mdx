...
Statsig supports both incoming outgoing events for Amplitude. As well as adding Ampltiude Cohorts to Statsig ID Lists.

## Incoming - Receving Events From Amplitude
