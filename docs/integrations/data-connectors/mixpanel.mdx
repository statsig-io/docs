...
1. Get a copy of your "Project Token" from Mixpanel by following this [guide](https://docs.mixpanel.com/docs/orgs-and-projects/managing-projects#find-your-project-tokens).
