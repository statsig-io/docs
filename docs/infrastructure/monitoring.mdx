...
| `statsig.sdk.events_successfully_sent_count`            | counter        | N/A                           | Tracks numbers of events sent successfullt to the Statsig server. |
| `statsig.sdk.sdk_exceptions_count`            | counter        | N/A                        | Tracks occurrences of unexpected exceptions caught. |
