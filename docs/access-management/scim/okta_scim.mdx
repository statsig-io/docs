...
## Changelog
- See [Changelog](/docs/access-management/scim/scim_changelog.md) for updates on SCIM functionality.

<div style={{borderBottom: "1px solid", marginBottom: "2rem", marginTop: "2rem"}} />
# Okta Integration
