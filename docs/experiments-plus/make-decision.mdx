...
After you make the decision, the variant that your users see depends on whether you're using a **targeting gate** for your experiment. The results for your experiment will still be accesible after you make a decision, but they will stop updating.  The last day of metrics will be the day you "make a decision" on the experiment.
