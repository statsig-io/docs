...
Bayesian experiments allow you to specify a prior belief on the relative average treatment effect. Statsig will combined the prior distribution with the observed data to display the prior-adjusted results.
...
The posterior distrbution is then calculated as
