...
Value: time (displayed in Console in your browser's local time, but converted to a unix timestamp for evaluation)

Example: Show the labor day sale banner on labor day

![Time example](https://github.com/user-attachments/assets/34432205-d986-48ff-b194-021f266f6c2c)
