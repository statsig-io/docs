...
You can use this to validate that a new feature does not regress existing metrics as you roll it out to everyone.  Statsig suggests a 2% -> 10% -> 50% -> 100% roll out strategy. Each progressive roll out will generate its own Metrtic Impact as shown below.
...
Alternatively, because this is such a common use-case, you can specify an environment for any of the other coniditions inline.  Here it is with an everyone condition, filtered to development environment.
