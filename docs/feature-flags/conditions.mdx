...
Value: unix timestamp.  Some server SDKs support additional formats - see the full list on the [server user]/server/concepts/user#time-based-conditions) documentation.
