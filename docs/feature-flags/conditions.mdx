...
Evaluations at a given percentage are _stable_ with respect to the userID. If userID = 4 passes a condition at a 50% rollout, they will always pass at that 50% rollout. Want to reset that stability? See [Resalting](https://docs.statsig.com/feature-flags/conditions#resalting).
