...
- A feature flag can be a simple _kill switch_ that you can use to turn off a particular code branch for all your users, or use [Safeguards](/safeguards/overview) to automatically roll back when issues are detected
