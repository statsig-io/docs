...
Yes, you can. When setting up your experiment, select a [Feature Flag](/feature-gates/overview) with targeting rules. In this case, only iOS users would pass the gate.
