...
## Can I filter bots from my experiments?
Yes. The most common way people achieve this is by creating a Segment that targets bots using the user agent string. You can then reference this Segment in any feature gates you create to exclude bots. When you edit this Segment to refine how you identify bots, all the active feature gates that reference it will benefit from the change. 
