...
## Does Statsig support mixed effect model?

We don’t support Mixed Effect Models at this time. Mixed effect models require specific business and product context to prevent introducing bias into your analysis. 

## Does Statsig support synthetic control?

We don’t support generalized synthetic controls at this time. Synthetic controls require specific and product context to prevent introducing bias into your analysis.

However, if you have set up synthetic controls yourself, in our Warehouse Native product you can set those assignment up in a table and link to an [Assignment Source](https://docs.statsig.com/statsig-warehouse-native/configuration/assignment-sources); from there, Statsig will handle the statistical analysis based on your synthetic assignments.
...
## How eas is it to export a customer report?
