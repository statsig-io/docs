...
You can customize the definition of DAU within the Statsig Console and specify or exclude a set of Statsig and custom events.  You can find this in the Settings tab > Project Dropdown > Project Info at the top right of the page.  If you have privileges, you can edit this.
