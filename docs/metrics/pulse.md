...
| event_user                            | Count of distinct users that have had the event.                         | Average metric value per user per day. The probability that a user has the event on a given day.                                                                        | All users           |
