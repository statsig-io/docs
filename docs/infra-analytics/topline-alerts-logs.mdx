...
In this example, we're going to walk through how to create a monitor success rate of a GET request.
...
## Best Practices
- Keep formulas simple (ratios or percentages are easiest to scan)
