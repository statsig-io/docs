...
<div>
  {props.addedInVersion ? "Added in version " : null}
  <props.addedInVersion />.
  You can query your gates/experiments without triggering an exposure as well as manually logging your exposures.
</div>
...
<Tabs
  ...
  values={[
    ...
    {label: 'Get Parameter Store', value: 'parameterstore'},
  ]}>
