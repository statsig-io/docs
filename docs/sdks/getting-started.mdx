...
Additionally, for frameworks like **Next.js** that bridge client and server-side logic, we guides like the [Next.js SDK](/client/javascript-sdk/next-js) to help you integrate.
