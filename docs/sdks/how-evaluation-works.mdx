...
Why do I have to wait for initialisation to complete?
...
The SDKs don’t “remember” user attributes, or previous evaluations: we rely on you to pass all of the necessary user attributes consistently - and we promise if you do, we’ll provide the same value. We don’t “remember” a users’ previous attributes or evaluations, as this would require the SDK doing “lookups” of previous exposures - which would not be possible within our performance promises. 
