...
<Tabs
  ...
  <Tabs>
    ...
    ```
    Note: you'll want to wait for the SDK to initialize before checking a gate to ensure it has fresh values, one way to accomplish this is waiting for the ["values_updated"](/client/javascript-sdk#client-event-emitter) event.
    </TabItem>
    <TabItem value="Get an Experiment Value">
    First, create an Experiment on the [Experiments page](https://console.statsig.com/experiments) in console
    ```jsx
    ...
    ```
    Note: you'll want to wait for the SDK to initialize before getting an experiment to ensure it has fresh values, one way to accomplish this is waiting for the ["values_updated"](/client/javascript-sdk#client-event-emitter) event.
    </TabItem>
    <TabItem value="Log an Event">
    You can use Events to power metrics in your experiment or gates. Events don't need to be set up in console first, just add to your code:
    ```jsx
