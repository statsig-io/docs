...
SDKs batches and flushes events in the background to our server. When the volume of input event is higher than the flushing volume, the SDK can drop events after so many retries. There are several things you can tune in statsig options to minimize event loss. 
![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54)
- event_queue_size: how many events to send in a single batch.
- retry_queue_size: how many batches of events to hold and retry for.
