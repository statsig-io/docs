...
<Tabs groupId="evalReasons">
    <TabItem value="client" label="Client SDKs">
        ...
        | State Name           | Description| Type | Debugging Suggestions|
        |-----------------|-----------------------------------------------------------------------------------------------------------------------------------------|------------|------------------------------------------------------------------------------------------------------------|
    ...
    <TabItem value="server" label="Server SDKS">
        ...
        | `Error`                | An unknown error occured during evaluation.| Error| Reach out to us in [Slack](https://statsig.com/slack) for support.|
