...
iOS: Available with `Statsig.openDebugView()`. Supported in [v1.26.0](https://github.com/statsig-io/ios-sdk/releases/tag/v1.26.0) and [above](https://github.com/statsig-io/ios-sdk/releases).

Android: Available with `Statsig.openDebugView()`. Supported in [v4.17.0](https://github.com/statsig-io/android-sdk/releases/tag/v4.17.0) and [above](https://github.com/statsig-io/android-sdk/releases).
