...
![Azure AI Studio model deployment creation interface](https://github.com/user-attachments/assets/3172d6f9-176e-4a3b-817f-3a5bd3af4291)

Once confirmed, you will be taken to the details page of that model.  

![Azure AI model deployment details page](https://github.com/user-attachments/assets/b8f46ed9-ce02-486f-b6f7-1d09f7b62f33)
...
![Statsig project settings API keys section](https://github.com/user-attachments/assets/f60f6f2b-60d0-4804-8db5-b82d4ac96bcf)
