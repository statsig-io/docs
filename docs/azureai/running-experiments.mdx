...
![Dynamic config setup interface](https://github.com/user-attachments/assets/3770f081-d68f-478e-8b3d-a36ef65d49c7)
...
![Metrics catalog creation interface](https://github.com/user-attachments/assets/89841414-6140-41f4-89ee-b09b83f2846c)
...
![Latency metric configuration screen](https://github.com/user-attachments/assets/0317d30a-a479-498d-8dd0-666f2db616e3)

### Step 3: Create an experiment

Create a new experiment in the Statsig console from https://console.statsig.com/experiments

![Experiment creation interface](https://github.com/user-attachments/assets/f1a93738-355f-4647-8444-9b6abfb72ffc)

In the **Setup** page, add the metrics you created in Step #2 in the **Primary Metrics** field.

![Primary metrics configuration screen](https://github.com/user-attachments/assets/eb47ec6c-bd9a-47d9-bca6-a6ce0ea4148b)
...
![Parameter setup interface](https://github.com/user-attachments/assets/4837063a-9dde-4c0b-8bca-584d98adae47)

Now add the two configs we created in Step #1, one each to Control and Test parameters like this:

![Experiment variant configuration screen](https://github.com/user-attachments/assets/b54a41de-a442-4870-870c-81ff949ecceb)
