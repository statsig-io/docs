...
If you're using a server core SDK, we have a method called .identify that accepts a StatsigUser object which will update the user profile from that object. 
