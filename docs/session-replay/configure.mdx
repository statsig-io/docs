...
### Initalization - StatsigTriggeredSessionReplay
...
- `autoStartRecording`
  - `true`: Recording _can_ start automatically after inialization. Global targeting gate and sample rate are respected
