...
To disable all logging to Statsig (both autocapture events and logging who has seen your experiments), you can configure this through your web analytics setup. This may be useful if you're dealing with GDPR compliance, and you can later re-enable events with `client.updateRuntimeOptions({disableLogging: false})`.
