...
:::info Statsig supports many different SDKs.  Please checkout [Getting Started](/) for the full list of Client side SDKs :::
...
### Step 6 - Let's try a different check

Now, let's update the user to include an employee email address, and see if the feature is available.
...
### Step 7 - How to use these gates in production
