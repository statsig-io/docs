...
```
This feature enables a new mobile optimized registration flow which we will be launching on iOS and Android as part of the V2 refresh.
```
...
**Test SDK Keys** are used to validate features without the events that you log messing with production data.
