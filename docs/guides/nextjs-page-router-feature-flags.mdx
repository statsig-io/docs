...
In this walkthrough, we'll integrate our [React Client SDK](/client/deprecated/reactSDK) and [NodeJS Server SDK](https://docs.statsig.com/server/nodejsServerSDK) into a simple Next.js app with Page Router and check a feature gate to determine if the end-user should see a new feature.
