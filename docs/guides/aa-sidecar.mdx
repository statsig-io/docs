...
![Sidecar experiment setup interface](/img/sidecar_aa_setup.png)
...
![Sidecar variant configuration screen](/img/sidecar_aa_select.png)

Repeating the step above, you'll do the exact same action for the variant 'Test'. Your set up should look like the following. 

![Sidecar A/A test final configuration](/img/sidecar_aa_final.png)
