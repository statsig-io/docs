...
:::info This guide assumes that you have successfully set up and configured Statsig Sidecar. For a step-by-step guide on how to do this, see our [“setting up Sidecar”](https://docs.statsig.com/guides/sidecar-experiments/setup) guide.:::
...
(Image on the screenshot of the sidecar with 'AA test'). 
...
(Add this image, but remove the groups: https://user-images.githubusercontent.com/74584483/174388696-4db2e3ce-69a0-400a-9cc3-b0d67bf1b097.png)
