...
![Flask app showing red background color](/img/red_backgroundcolor.png)
...
![Statsig experiment configuration with red and blue variants](/img/redblue_abtest.png)
...
:::note
You won't see a different one every time due to how our randomization works, but over time, the distribution should be even. If not, you may have a [Sample Ratio Mismatch]((https://www.statsig.com/blog/sample-ratio-mismatch).
:::
