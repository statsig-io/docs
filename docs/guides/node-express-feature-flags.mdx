...
In this tutorial we'll integrate our [NodeJS Server SDK](https://docs.statsig.com/server/nodejsServerSDK) into a simple expressJS app and check a feature gate to determine if the end user should see a new feature. 
