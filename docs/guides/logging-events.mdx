...
The events you log is aggregated and analyzed by Statsig to give you useful metrics.  These can be sliced and diced in the [Metrics Explorer](/product-analytics/overview).

![Metrics Explorer](https://github.com/user-attachments/assets/9d9e205e-00b2-49a4-ac36-47e855a17a33)

You can also collect relevant metrics and charts into saveable [Dashboards](/product-analytics/dashboards):

![Dashboards](https://github.com/user-attachments/assets/a71fe706-913a-4e6e-8f4f-290f492989c7)
...
![Pulse Results](https://github.com/user-attachments/assets/bb554ff2-d0d5-4689-b8eb-915c232b023d)
