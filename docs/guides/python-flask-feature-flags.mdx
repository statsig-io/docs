...
Click next in the Statsig console, and you'll be given the opportunity to name your flag. I've called mine secret_route, and left "user_id" as the default. Click next, and set the "rule" on your feature flag to allowing "Everyone" (in the drop down) and leave the "pass percent" at 100%. Click next and you should see a - for now empty - log stream. Now, change your secretRoute function to look like this:
...
But if you click the "back" button on your Statsig console, change the rule to 100% fail, then wait a moment and refresh, you should see "access denied" checking your secretRoute. Congratulations! You've set up your first feature flag. 
