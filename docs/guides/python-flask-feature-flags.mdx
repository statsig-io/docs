...
![Feature gate rule configuration with Everyone at 100% pass](/img/everyone_gate.png)
...
![Feature gate rule configuration with Everyone at 0% pass](/img/everyone0_gate.png)
...
![Feature gate email targeting rule configuration](/img/statsigemail_gate.png)
