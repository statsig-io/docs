...
### Step 3: Set up the urls for landing pages
...
### Step 6: Add code snippet

In your landing pages, add the following code snippet in the ```<head>``` section.  Make sure you replace the ```[API_KEY]``` with the Client API Key you copied in **Step 5**, and ```[EXP_NAME]``` with the Experiment Name you copied in **Step 4**.
