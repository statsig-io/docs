...
***NOTE***- If you are seeing a larger than expected number of metrics showing a stat-sig lift, your sampling may be biased. In this scenario, our recommendation is to resalt  (accessed via the **...** menu in the upper right-hand corner on the feature gate page) and re-run.
