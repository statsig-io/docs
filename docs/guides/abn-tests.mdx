...
* Integrated the **Statsig Client SDK** into your application
* **Checked the experiment** in your application code using the `getExperiment` function
...
If you want to measure other events or custom metrics, you'll need to log them to Statsig. Continue to the next tutorial to learn how to log custom events and metrics with the Statsig SDK.