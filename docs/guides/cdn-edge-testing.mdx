...
You can now use our [Akamai Edge integration](/integrations/akamai), which includes an integration with EdgeKV as well as a Node package that how been tested and validated within Akamai edge runtime. 
