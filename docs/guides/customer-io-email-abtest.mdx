...
Through your Customer.io workflow's Build module, create a **Random Cohort Branch** and add a **Send and Receive Data**hook to build a flow similar to the following:

![Customer.io random cohort branch setup](https://user-images.githubusercontent.com/87334575/211873572-0966ae02-4a41-40a1-b55d-19378f1d0b98.png)

Then, click on one of your webhooks to **Add Request**, which opens up the following workspace to put in a post request similar to the following, with your api key and experiment name filled in:

![Webhook configuration for experiment exposure](https://user-images.githubusercontent.com/87334575/211873593-d48ed161-2a55-4099-8f06-7835ee82d011.png)
...
![Experiment group exposure configuration](https://user-images.githubusercontent.com/87334575/211873585-1b2da267-cd72-4c29-acde-d1888500ac36.png)
...
![Customer.io holdout branch configuration](https://user-images.githubusercontent.com/87334575/211888584-a164d8bf-0d78-4a6b-86ab-ea336fd2bc3a.png)
