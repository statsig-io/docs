...
![Feature gate rules with raw user IDs](/img/id_resolver1.png)
...
![Feature gate rules with resolved ID names](/img/id_resolver2.png)
...
![ID autocomplete functionality in action](/img/id_resolver3.png)
...
![ID resolver usage across console interfaces](/img/id_resolver_4.png)
...
![ID resolver integration setup screen](/img/id_resolver_setup_1.png)

![ID resolver webhook configuration interface](/img/id_resolver_setup_2.png)
