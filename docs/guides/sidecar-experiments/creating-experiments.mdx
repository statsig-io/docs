...
![Sidecar experiment interface](/img/sidecarfull.png)
...
![New experiment creation form](https://github.com/statsig-io/.github/assets/74588208/d8cfc8bb-43e9-4a64-8ca8-002c579e7fff)
...
![URL targeting configuration interface](/img/sidecarurls.png)
...
![Add action selection menu](/img/sidecaraddaction.png)
...
![Redirect action configuration](/img/sidecarredirect.png)
...
![Element selection with red highlight](/img/sidecarselect.png)

Sidecar will now reflect the path of the element that was selected.

![Selected element path display](/img/sidecarpath.png)
...
![Content update interface with preview](/img/sidecarupdatelt.png)
...
![Adding additional experiment actions](/img/sidecar2ndaction.png)
