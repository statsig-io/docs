...
Note, this works best with the default test/control group names - if you change one of your groupnames, you'll also have to modify it in the Statsig Console by clicking "Manage Overrides"
