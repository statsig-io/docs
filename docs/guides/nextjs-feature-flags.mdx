...
In this tutorial, we'll integrate our [React Client SDK](/client/deprecated/reactSDK) and [NodeJS Server SDK](/server/nodejsServerSDK) into a simple Next.js app with App Router and check a feature gate to determine if the end-user should see a new feature. 
...
First install the Statsig [React SDK](/client/deprecated/reactSDK)
...
First install the Statsig [Node SDK](/server/nodejsServerSDK)
