...
1. **Log into the Statsig Console**: Head over to [Statsig Console](https://console.statsig.com/) and navigate to **Project Settings** in the top-right corner of the dashboard.
   
2. **Find Custom Unit IDs**: Under the **Basic Settings** tab, look for the **Custom Unit IDs** section.
...
Once added, this custom Unit ID can be used across all your experiments. You only need to configure it once for your project!
