...
description: "Migrate from the legacy Statsig Node.js Server SDK to the new Node Core SDK, including API changes, imports, and configuration updates for backend services."
