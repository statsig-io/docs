...
:::info
Statsig Server Core is currently in beta - we encourage you to try it out and give us feedback in the [Statsig Slack](https://statsig.com/slack). If you're having trouble, you can fallback to the [legacy SDKs](https://docs.statsig.com/server-core/legacy-sdks).
:::
