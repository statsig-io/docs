...
Server Core also introduces many new features: 
 - [Parameter Stores](https://docs.statsig.com/client/concepts/parameter-stores/), including the ability to Bootstrap client SDKs with parameter stores
 - [SDK Observability Interface](https://docs.statsig.com/sdk_monitoring/#metric-interface-methods)
 - Streaming flag/experiment changes (with the [Statsig Forward Proxy](/server/concepts/forward_proxy/))

Server Core is currently available for Java, Node, Elixir, Rust and Python. Need another language? Let us know in the [Statsig Slack](https://statsig.com/slack) and we'll prioritize it.