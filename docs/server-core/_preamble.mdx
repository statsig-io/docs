...
Server Core is currently available for Java and Python. Need another language? Let us know in the [Statsig Slack](https://statsig.com/slack) and we'll prioritize it.