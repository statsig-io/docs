...
{props.forwardLogLineEvent ? (
  <>
    <p>
      You can forward logs to Logs Explorer for convenient analysis using the Forward Log Line Event API. This lets you include custom metadata and event values with each log. Learn more about [Logs Explorer and Infra Analytics](/infra-analytics/logs-explorer).
    </p>
  ...
  <>
    <p>
      Sending events to Log Explorer is not yet available for this sdk. Need it now? Let us know in <a href="https://statsig.com/slack">Slack</a>.
    </p>
  </>
)}
