...
| `uber` | Self-contained JAR with both core library and native libraries for all supported platforms (if used, no other dependencies needed) | `implementation 'com.statsig:javacore:X.X.X:uber'` |
