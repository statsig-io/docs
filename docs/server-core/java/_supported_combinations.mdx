...
| `uber` | Self-contained JAR with both core library and native libraries for popular supported platforms (available since version 0.4.0, if used, no other dependencies needed) | `implementation 'com.statsig:javacore:X.X.X:uber'` |
