...
| `uber` | Self-contained JAR with both core library and native libraries for popular supported platforms (available since version 0.4.0, if used, no other dependencies needed). See platform list below. | `implementation 'com.statsig:javacore:X.X.X:uber'` |

**Uber JAR supported platforms:**
- Linux (x86_64, arm64)
- macOS (x86_64, arm64)
- Windows (x86_64)
