...
| `uber` | Self-contained JAR with both core library and native libraries for popular supported platforms (available since version 0.4.0, if used, no other dependencies needed) The uber JAR includes native libraries for:
- Linux (x86_64, arm64)
- macOS (x86_64, arm64)
- Windows (x86_64) | `implementation 'com.statsig:javacore:X.X.X:uber'` |
