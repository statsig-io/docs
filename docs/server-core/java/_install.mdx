...
1. Install the core library (see [Step 1: Install Core Library](#step-1-install-core-library))
2. Add the platform-specific dependency using either:
   - [Automatic Detection](#method-1-automatic-detection) (recommended for most users)
   - [Manual Configuration](#method-2-manual-configuration) (if you know your exact platform requirements)

For detailed usage examples and API reference, check out our [Java SDK Documentation](/server-core/java-core).
