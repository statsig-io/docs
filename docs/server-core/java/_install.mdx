...
Since version 0.4.0, Statsig provides an "uber" JAR that contains both the core library and native libraries for all supported platforms in a single package. This is the recommended approach for most users.
