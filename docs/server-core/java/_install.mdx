import { RequirementsList, StyledHeading, InstallStep } from '@site/src/components/JavaCoreStyles';

<StyledHeading level={2}>Requirements</StyledHeading>
...
<StyledHeading level={2}>Overview</StyledHeading>
