...
Since version 0.4.0, Statsig provides an "uber" JAR that includes native libraries for all supported platforms. This simplifies dependency management, especially for applications that need to run on multiple platforms.
