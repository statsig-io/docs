...
Now that you've installed the SDK, check out our sample applications to see how to use the SDK in practice:

- [Java Sample App](https://github.com/statsig-io/java-sdk/tree/main/samples) - A complete example showing how to use the SDK in a Java application
- [Spring Boot Sample App](https://github.com/statsig-io/java-sdk/tree/main/samples/spring-boot) - An example of integrating the SDK with a Spring Boot application

These samples demonstrate common use cases and best practices for using the Statsig Java SDK.
