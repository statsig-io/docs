...
- Compatible with the following platforms:
  ...
  - Linux/Amazon Linux (x86_64, arm64)
...
Replace `YOUR-OS-ARCHITECTURE` with one of the supported combinations from the [Supported OS and Architecture Combinations](#supported-combinations) section.
