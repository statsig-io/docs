...
- Java 8 or higher (Java 8 support added in version 0.4.0)
...
**Option 1: Two-part installation** (traditional approach)
...
**Option 2: Single JAR installation** (since version 0.4.0)
- Use the "uber" JAR which contains both the core library and all platform-specific native libraries in a single package
...
<details>
<summary>Method 2: Using the Uber JAR (includes all platforms)</summary>

Since version 0.4.0, Statsig provides an "uber" JAR that contains both the core library and native libraries for all supported platforms in a single package. This simplifies dependency management, especially for applications that need to run on multiple platforms. When using the uber JAR, you don't need any other dependencies.
...
<details>
<summary>Method 3: Manual Configuration</summary>
