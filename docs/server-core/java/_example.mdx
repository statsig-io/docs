...
dependencies {
    ...
    // Option 2: Self-contained Uber JAR (includes all platforms, available since version 0.4.0)
    // implementation 'com.statsig:javacore:X.X.X:uber'  // No need for the core dependency when using uber JAR
}
