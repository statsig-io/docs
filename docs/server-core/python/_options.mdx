...
- **`data_store`**: `Optional[DataStoreBase]`  
  Interface to implement custom caching logic for Statsig configurations. For details, see the [Data Store Interface](https://docs.statsig.com/server/concepts/data_store) documentation.
