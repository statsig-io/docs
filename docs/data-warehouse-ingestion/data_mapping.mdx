...
- For users with null values, we will infer 0 for metric_value, and exclude null value users for ratior metrics.
...
### Exposure Events
:::info
NOTE: Exposure event import is deprectated. If this is an important use case, see [Statsig Warehouse Native](https://www.statsig.com/blog/announcing-statsig-warehouse-native), available to Enterprise Customers 
:::
