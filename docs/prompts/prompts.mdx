---
title: Prompt Management (AI Evals)

sidebar_label: Prompts (AI Evals)
slug: /prompts
keywords:
  - owner:vm
last_update:
...
1. Create a Prompt. This contains the prompt for your task (e.g. Summarize ticke content. Don't include email addresses or credit cards in the summary). Create a v2 prompt that improves on this.
