...
1. [type=first_exposures](/pulse/export/#first-exposures-file-description) - Provides a link to download your company's full set of "first exposures" across feature gates and experiments.
2. [type=pulse_daily](/pulse/export/#pulse-summary-file-description---for-experiments) - Provides a link to download your company's daily experimental results. This data is a single day's results and a full experimental analysis requires the entire duration of the experiment.
