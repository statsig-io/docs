...
- Besides the exposure reports from the API access, we also offer data warehouse export to Snowflake for our enterprise customers. Currently, you need to contact our support team to set it up.
