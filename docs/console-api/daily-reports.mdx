...
1. Navigate to [] -> Exports. Under the `Scheduled` tab, create a new connection.
...
```
3. Connect. Then StatSig will run tests to make sure all privileges are granted. Once it's successful, you are enrolled in the feature.
