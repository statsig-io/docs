...
description: Use Statsig dynamic config parameters in your application to control behavior in near real-time, including reading values and handling parameter changes.
---
...
<Frame>
  <img src="/images/dynamic-config/working-with/129110998-d2d1cb31-cd87-4f93-81f0-21ab64565763.png" alt="Dynamic config localization interface" />
</Frame>

A sample JSON payload for French speakers is also shown below.

<Frame>
  <img src="/images/dynamic-config/working-with/129111399-c3f0354e-f55d-43fc-b49c-f74eac89bc11.png" alt="JSON payload example for French localization" />
</Frame>
