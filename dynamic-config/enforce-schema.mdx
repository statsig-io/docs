...
description: Use JSON Schema in Statsig dynamic configs to enforce consistent return value shapes across rules and catch invalid configuration before it ships.
---
