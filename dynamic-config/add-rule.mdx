---
title: Adding Rules
description: Add targeting rules to Statsig dynamic configs to control which users receive specific JSON values based on user, environment, or custom attributes.
---
...
- Select the criteria for identifying the users you want to target:
  ...
  <Frame>
    <img src="/images/dynamic-config/add-rule/129112226-51978083-d007-4697-88b5-f3a080eabf48.png" alt="Operating system targeting rule configuration" />
  </Frame>

  - You can target users in a defined [segment](/segments) as shown below

  <Frame>
    <img src="/images/dynamic-config/add-rule/129112427-27351aaf-074e-4997-91d8-6e1e7941b991.png" alt="User segment targeting rule configuration" />
  </Frame>
  ...
  <Frame>
    <img src="/images/dynamic-config/add-rule/129112612-d881981c-4fc6-4e95-a9c5-18319c02d6f2.png" alt="Feature gate targeting rule configuration" />
  </Frame>
...
<Frame>
  <img src="/images/dynamic-config/add-rule/129113189-30e7e7da-7559-4d3a-8bd3-74a6ccb7afe2.png" alt="JSON configuration editor interface" />
</Frame>
