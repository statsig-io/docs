---
title: API Keys
description: "Reference for Statsig API keys, including client keys, server secret keys, and console API keys, with guidance on rotation, scopes, and security."
---
