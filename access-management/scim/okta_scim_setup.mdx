...
description: "Step-by-step guide to set up Okta SCIM provisioning with Statsig, including the integration app, attribute mappings, and group assignment configuration."
sidebarTitle: Setup
---
...
<Frame>
  <img src="/images/okta_scim_steps/step1-create-new-custom-integration.png" alt="Okta Create App Integration dialog selecting Secure Web Authentication" />
</Frame>
...
<Frame>
  <img src="/images/okta_scim_steps/step2-configure-app-settings.png" alt="Okta app settings form with Statsig SCIM name and placeholder login URL" />
</Frame>
...
<Frame>
  <img src="/images/okta_scim_steps/step3-enable-scim.png" alt="Okta application general tab highlighting provisioning section and SCIM toggle" />
</Frame>
...
<Frame>
  <img src="/images/okta_scim_steps/step4.png" alt="Okta provisioning tab showing SCIM base URL and push settings" />
</Frame>
