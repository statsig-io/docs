...
description: "Reference for configuring Okta SCIM provisioning with Statsig using the OIN-submitted integration, including supported operations and limitations."
sidebarTitle: Setup (OIN SUBMISSION)
---

## ⚠️⚠️ This is required documentation for our official Okta integration submission. For now, please reference the existing guide at [Setup](/access-management/scim/okta_scim_setup)
...
- Navigate to Applications > Applications > Browse App Catalog
  ...
  ![image](/images/access-management/scim/okta-scim/scim_step_1.1.png)

- Search for and select "Statsig"

  ![image](/images/access-management/scim/okta-scim/scim_step_1.2.png)

- Select "Add Integration"

  ![image](/images/access-management/scim/okta-scim/scim_step_1.3.png)

- Set your desired application label, then select "Done"
  ![image](/images/access-management/scim/okta-scim/scim_step_1.4.png)
...
- **⚠️Important⚠️** Prepend "Bearer " to the token obtained from Statsig, e.g. "Bearer scim-G22A\*\*\*"
  ![image](/images/access-management/scim/okta-scim/scim_step_2.1.png)
...
<Frame>
  ...
  actions](/images/okta_scim_steps/step5-configure-okta-to-statsig-settings.png)
</Frame>
...
<Frame>
  ...
  groups](/images/okta_scim_steps/step6-import-existing-users.png)
</Frame>
