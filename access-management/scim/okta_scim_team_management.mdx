...
description: "Manage Statsig teams from Okta using SCIM provisioning so team membership stays in sync with Okta groups and reflects organizational changes automatically."
