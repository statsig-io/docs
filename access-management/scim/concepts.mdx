---
title: SCIM Concepts
description: "Core SCIM concepts in Statsig, including users, groups, role mappings, and how provisioning sync works between your identity provider and Statsig."
---
...
<Frame>
  <img src="/images/okta_scim_steps/okta-statsig-group.png" alt="Mapping diagram showing Okta group synced to Statsig project and team roles via SCIM" />
</Frame>
