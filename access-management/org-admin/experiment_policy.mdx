...
description: "Configure organization-level experiment policies in Statsig to require approvals, reviewers, and quality gates before launching A/B tests across projects."
---
...
Organization Experiment Policies can be managed by visiting  Product Configuration → Experimentation → [Organization tab](https://console.statsig.com/settings/products/experimentation). Only organization admins have the ability to modify these settings.
