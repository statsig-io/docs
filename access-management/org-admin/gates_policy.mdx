...
description: "Configure organization-level feature gate policies in Statsig to require approvals, reviewers, and review checks before publishing changes to gates."
---
