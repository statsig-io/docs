...
Once these steps have been completed, the Statsig OIDC Application in Okta has been successfully configured. Next, you will need to follow the steps [here to enable configuration of SSO on your Statsig Organization](https://docs.statsig.com/access-management/sso/overview#in-statsig-console).
