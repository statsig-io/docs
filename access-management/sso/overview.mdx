...
If there are multiple projects, users will be added to the organziation but will need to request to join open projects or be invited to closed projects.
