---
title: Teams
description: "Configure Statsig Teams to add an organizational and permissions layer on top of a project, enabling team-scoped settings, reviewers, and ownership."
---
<Info>
...
<Frame>
  <img src="/images/team_create_1.png" alt="Statsig Teams page showing member list with project and team roles" />
</Frame>
...
<Frame>
  <img src="/images/access-management/teams/d11ed451-7fff-4031-b117-4cd05cb3b960.png" alt="Project configuration toggle requiring configs to be associated with teams" />
</Frame>
...
<Frame>
<img width="881" alt="Statsig Team settings showing default monitoring metrics selection" src="/images/access-management/teams/16f0ccfd-05d6-4fb2-8992-ec8780ff3778.png"/>
</Frame>
...
<Frame>
  <img src="/images/access-management/teams/554e0f6a-c9ce-466a-b5a4-db94b0cb24fa.png" alt="Team require reviews option within settings" />
</Frame>
...
<Frame>
<img width="924" alt="Default allowed reviewers dropdown specifying who can approve changes" src="/images/access-management/teams/39263840-cb37-4286-b30a-c6d255f218d0.png"/>
</Frame>
...
<Frame>
<img width="919" alt="Create and edit configs permissions for team members only or entire project" src="/images/access-management/teams/df517c17-acdd-4516-a9ee-bc612a0bfdc9.png"/>
</Frame>
...
<Frame>
  <img src="/images/access-management/teams/2cf75c17-9441-4645-beef-feb57578fb46.png" alt="Team default target applications selector" />
</Frame>
...
<Frame>
  <img src="/images/access-management/teams/8f5a2226-c716-4882-939a-8ba53e852b22.png" alt="Team default holdout configuration UI" />
</Frame>
...
<Frame>
  <img src="/images/access-management/teams/dbdc681d-3918-4da1-b9e3-6e43ecb744f8.png" alt="Config creation screen with team selection dropdown" />
</Frame>
...
<Frame>
  <img src="/images/access-management/teams/7fc0faf7-c059-451b-8a44-6f58e526ef8e.png" alt="Config header showing Team field separate from Owner" />
</Frame>
...
<Frame>
  <img src="/images/access-management/teams/299cc0ad-5878-454b-9186-e005f8f442b5.png" alt="Console list filters for gates experiments and metrics by team" />
</Frame>
