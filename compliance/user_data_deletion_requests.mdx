...
description: "How to submit and process user data deletion requests in Statsig to comply with GDPR, CCPA, and other privacy regulations across SDK and console data."
---
...
- Please note that this User Data Deletion Requests API only deletes data from the Statsig platform. To delete data from the Amplitude platform, please use this [User Privacy API](https://amplitude.com/docs/apis/analytics/user-privacy).
