...
last_update:
  date: 2025-05-21
description: Statsig collects only the data that you configure to be sent to Statsig. This is typically the occurrence of feature flag evaluations (Feature Flags),
---

## General

### What data does Statsig collect from users of my app?
Statsig collects only the data that you configure to be sent to Statsig. This is typically the occurrence of feature flag evaluations (Feature Flags), experiment exposures, and custom events you log with the SDK.
...
- stableID: A persistent device identifier (refer to the following example)
