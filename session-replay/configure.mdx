...
description: "Configure Statsig Session Replay sampling rates, privacy masking rules, network capture settings, and event triggers across your applications."
...
<img
  src="/images/session_replay/settings.png"
  alt="Session replay settings panel with targeting and sampling controls"
/>

<img
  src="/images/session_replay/conditional_recording_flowchart.png"
  alt="Flowchart outlining conditional recording logic for events and exposures"
...
<Note>
  ...
  session_id. So if `purchase_event` fails the sampling rate once, future
