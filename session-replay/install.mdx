...
description: Session Replay is supported on the Javascript or React SDKs for both desktop and mobile web users on your web application. See the instructions below 
---
...
This page explains option 1 - no code - add javascript snippet to your website.
