...
sidebarTitle: Watch
description: Session Replays can be found under the User’s group in the Statsig console’s navigation panel. <Frame> <img src="/images/session-replay/watch/2f9ca1b1
---

Session Replays can be found under the User’s group in the Statsig console’s navigation panel. 

<Frame>
  <img src="/images/session-replay/watch/2f9ca1b1-f8e0-403f-9d3f-898434f06266.png" alt="Session replay navigation in Statsig console" />
</Frame>
...
<Frame>
  <img src="/images/session-replay/watch/f810ceb5-b6fc-4312-8e5d-9acfec0809bb.png" alt="Session replay interface with playback controls and events panel" />
</Frame>


For a more immersive replay experience you can hide the events panel: 
<Frame>
  <img src="/images/session-replay/watch/d63fdf9e-cfc4-45e5-9365-d478504574c3.png" alt="Session replay interface with hidden events panel" />
</Frame>
...
<Frame>
  <img src="/images/session-replay/watch/45ce3a59-6847-43d6-bfc8-6d3cd5d45917.png" alt="Session replay selection interface with replay cards" />
</Frame>
