...
description: "Use Statsig Session Replay to debug user-reported issues by replaying real sessions alongside console logs, network requests, and feature gate values."
sidebarTitle: Debug
---
