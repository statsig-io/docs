...
description: "Monitor Statsig SDK health from the Statsig console, including initialization success rate, evaluation latency, network errors, and version adoption."
