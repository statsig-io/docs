...
last_update:
  date: 2025-09-18
description: <Note> This latest release of structured logging and metrics, is currently only [available by the Python SDK](/server/pythonSDK/#sdk-monitoring-). Wan
---
