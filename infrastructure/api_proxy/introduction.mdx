---
title: API Proxy
description: "Introduction to Statsig API proxy options for caching SDK requests, reducing latency, and meeting compliance requirements in your infrastructure."
keywords:
  - owner:eric
last_update:
  date: 2025-09-18
