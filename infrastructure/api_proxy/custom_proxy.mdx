...
description: "Run a custom Statsig API proxy in your own infrastructure to cache SDK requests, reduce latency, and control egress traffic from production servers."
slug: /custom_proxy
keywords:
  - owner:eric
last_update:
